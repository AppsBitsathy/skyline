...
class ISI_8034_RD_FlowGraphController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('8034.entry.pumpTestingRD.graphs.flow.g1', compact('isiGraphScale'));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g1(Request $request)
    {
        try {
            ...
            $isiGraphScale = isi_8034_Scale::where('fldpno', '=', $request['coPumpNo'], 'and', 'fldsno', '=', $request['coPumpType'], 'and', 'gtype', '=', 'Flowmetric')->orderBy('id', 'DESC')->limit(1)->get();

            $isiGraphScaleValues = $isiGraphScale[0];

            $flowmetricsValues = isi_8034_EntryPumpTest::where('fldpno', '=', $request['coPumpNo'], 'and', 'fldsno', '=', $request['coPumpType'])->orderBy('id', 'DESC')->get();
            ...
            return view('8034.entry.pumpTestingRD.graphs.flow.g1', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g2(Request $request)
    {
        try {
            ...
            return view('8034.entry.pumpTestingRD.graphs.flow.g2', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g3(Request $request)
    {
        try {
            ...
            return view('8034.entry.pumpTestingRD.graphs.flow.g3', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g4(Request $request)
    {
        try {
            ...
            $flowmetricsValues = isi_8034_EntryPumpTest::where('fldpno', '=', $request['coPumpNo'], 'and', 'fldsno', '=', $request['coPumpType'])->orderBy('id', 'DESC')->get();
            $flowmetricsValuesASC = isi_8034_EntryPumpTest::where('fldpno', '=', $request['coPumpNo'], 'and', 'fldsno', '=', $request['coPumpType'])->orderBy('id', 'ASC')->get();
            ...
            return view('8034.entry.pumpTestingRD.graphs.flow.g4', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump', 'flowmetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g5(Request $request)
    {
        try {
            ...
            return view('8034.entry.pumpTestingRD.graphs.flow.g5', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump', 'flowmetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g6(Request $request)
    {
        try {
            ...
            return view('8034.entry.pumpTestingRD.graphs.flow.g6', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump', 'flowmetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g7(Request $request)
    {
        try {
            ...
            return view('8034.entry.pumpTestingRD.graphs.flow.g7', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump', 'flowmetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g8(Request $request)
    {
        try {
            ...
            return view('8034.entry.pumpTestingRD.graphs.flow.g8', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump', 'flowmetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g9(Request $request)
    {
        try {
            ...
            return view('8034.entry.pumpTestingRD.graphs.flow.g9', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump', 'flowmetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g10(Request $request)
    {
        try {
            ...
            return view('8034.entry.pumpTestingRD.graphs.flow.g10', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump', 'flowmetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
            ...
            if ($request->isMethod('post')) {
                if ($request->input('_token')) {
                    ...
                    if ($checkPump) {
                        ...
                        $flow = isi_8034_EntryPumpTest::where('fldpno', '=', $request->input('coPumpNo'))
