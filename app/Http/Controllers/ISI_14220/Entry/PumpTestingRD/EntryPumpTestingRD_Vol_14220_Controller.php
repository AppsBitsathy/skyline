...
class EntryPumpTestingRD_Vol_14220_Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            if (count($request->query()) > 0) {
                ...
                return view('14220.entry.pumpTestingRD.volumetric', compact('allPumps', 'entries', 'allEntryValues', 'pType'));
            }
            return view('14220.entry.pumpTestingRD.volumetric', compact('allPumps', 'allEntryValues'));
        } catch (Exception $ex) {
    ...
    public function view_report_page(Request $request, $pumpNo = null, $pumpName = null)
    {
        try {
            ...
            if ($pumpDetails == null) return redirect()->route('14220_entryPumpTestRDVol')->with('status', 'Pump not exist!');
            $entryDetails = isi_14220_EntryPumpTest::where('fldsno', '=', $pumpNo)->where('fldpno', '=', $pumpName)->get();
            if (sizeof($entryDetails) == 0) return redirect()->route('14220_entryPumpTestRDVol')->with('status', 'Pump data not exist!');
            ...
            return view('14220.entry.pumpTestingRD.report_vol', compact('pumpData', 'tableData'));
        } catch (Exception $ex) {
            return redirect()->back()->with('status', 'Internal Error!' . $ex->__toString());
        }
    }
    ...
    public function create_pdf()
    {
        ...
        $pdf = PDF::loadView('14220.entry.pumpTestingRD.report_vol', compact('pumpData', 'tableData'))->setPaper('a3', 'landscape');
    ...
    public function delete(Request $request)
    {
        try {
            ...
            return redirect()->route('14220_entryPumpTestRDVol')->with('status', 'Record Deleted!');
        } catch (Exception $ex) {
