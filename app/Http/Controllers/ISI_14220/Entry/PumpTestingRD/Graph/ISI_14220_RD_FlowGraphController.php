...
namespace App\Http\Controllers\ISI_14220\Entry\PumpTestingRD\Graph;

use App\Http\Controllers\Controller;
use App\Models\ISI_14220\Entry\isi_14220_EntryPumpTestGraphAddPrint;
use App\Models\ISI_14220\Entry\isi_14220_EntryPumpTestRDGraphReport;
...
class ISI_14220_RD_FlowGraphController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('14220.entry.pumpTestingRD.graphs.flow.g1', compact('isiGraphScale'));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g1(Request $request)
    {
        try {
            ...
            $isiGraphScale = isi_14220_Scale::where('fldpno', '=', $request['coPumpNo'], 'and', 'fldsno', '=', $request['coPumpType'], 'and', 'gtype', '=', 'Flowmetric')->orderBy('id', 'DESC')->limit(1)->get();

            $isiGraphScaleValues = $isiGraphScale[0];

            $flowmetricsValues = isi_14220_EntryPumpTest::where('fldpno', '=', $request['coPumpNo'], 'and', 'fldsno', '=', $request['coPumpType'])->orderBy('id', 'DESC')->get();
            ...
            return view('14220.entry.pumpTestingRD.graphs.flow.g1', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g2(Request $request)
    {
        try {
            ...
            return view('14220.entry.pumpTestingRD.graphs.flow.g2', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g3(Request $request)
    {
        try {
            ...
            return view('14220.entry.pumpTestingRD.graphs.flow.g3', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g4(Request $request)
    {
        try {
            ...
            $flowmetricsValues = isi_14220_EntryPumpTest::where('fldpno', '=', $request['coPumpNo'], 'and', 'fldsno', '=', $request['coPumpType'])->orderBy('id', 'DESC')->get();
            $flowmetricsValuesASC = isi_14220_EntryPumpTest::where('fldpno', '=', $request['coPumpNo'], 'and', 'fldsno', '=', $request['coPumpType'])->orderBy('id', 'ASC')->get();
            ...
            return view('14220.entry.pumpTestingRD.graphs.flow.g4', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump', 'flowmetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g5(Request $request)
    {
        try {
            ...
            return view('14220.entry.pumpTestingRD.graphs.flow.g5', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump', 'flowmetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g6(Request $request)
    {
        try {
            ...
            return view('14220.entry.pumpTestingRD.graphs.flow.g6', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump', 'flowmetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g7(Request $request)
    {
        try {
            ...
            return view('14220.entry.pumpTestingRD.graphs.flow.g7', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump', 'flowmetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g8(Request $request)
    {
        try {
            ...
            return view('14220.entry.pumpTestingRD.graphs.flow.g8', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump', 'flowmetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g9(Request $request)
    {
        try {
            ...
            return view('14220.entry.pumpTestingRD.graphs.flow.g9', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump', 'flowmetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g10(Request $request)
    {
        try {
            ...
            return view('14220.entry.pumpTestingRD.graphs.flow.g10', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump', 'flowmetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function excel(Request $request)
    {
        ...
        //     $title = new Title('Pump Performance Testing As Per IS 14220');
            ...
            if ($request->isMethod('post')) {
                if ($request->input('_token')) {
                    ...
                    if ($checkPump) {
                        ...
                        $flow = isi_14220_EntryPumpTest::where('fldpno', '=', $request->input('coPumpNo'))
    ...
    public function view_report_page(Request $request)
    {
        try {
            ...
            $pumpDetails = isi_14220_MasterPumpTypes::where('fldsno', '=', $inputs['coPumpType'])->first();
            $entryDetails = isi_14220_EntryPumpTest::where('fldsno', '=', $inputs['coPumpType'])->where('fldpno', '=', $inputs['coPumpNo'])->get();

            $report = new isi_14220_EntryPumpTestRDGraphReport();
            $report->truncate();
            ...
            $pumpData = isi_14220_EntryPumpTestRDGraphReport::orderBy('id', 'desc')->first();
            $tableData = isi_14220_EntryPumpTestRDGraphReport::all();
            return view('14220.entry.pumpTestingRD.graphs.report', compact('pumpData', 'tableData'));
        } catch (Exception $ex) {
            return redirect()->back()->with('status', 'Try again!, Catch Error: ' . $ex->__toString());
        }
    }
    ...
    public function create_pdf()
    {
        ...
        $pdf = PDF::loadView('14220.entry.pumpTestingRD.graphs.report', compact('pumpData', 'tableData'))->setPaper('a4', 'landscape');
