...
class ISI_6595_RD_VolGraphController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('6595.entry.pumpTestingRD.graphs.vol.g1', compact('isiGraphScale'));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g1(Request $request)
    {
        try {
            ...
            $isiGraphScale = isi_6595_Scale::where('fldpno', '=', $request['coPumpNo'], 'and', 'fldsno', '=', $request['coPumpType'], 'and', 'gtype', '=', 'Volumetric')->orderBy('id', 'DESC')->limit(1)->get();

            $isiGraphScaleValues = $isiGraphScale[0];

            $volumetricsValues = isi_6595_EntryPumpTest::where('fldpno', '=', $request['coPumpNo'], 'and', 'fldsno', '=', $request['coPumpType'])->orderBy('id', 'DESC')->get();
            ...
            return view('6595.entry.pumpTestingRD.graphs.vol.g1', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g2(Request $request)
    {
        try {
            ...
            return view('6595.entry.pumpTestingRD.graphs.vol.g2', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g3(Request $request)
    {
        try {
            ...
            return view('6595.entry.pumpTestingRD.graphs.vol.g3', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g4(Request $request)
    {
        try {
            ...
            $volumetricsValues = isi_6595_EntryPumpTest::where('fldpno', '=', $request['coPumpNo'], 'and', 'fldsno', '=', $request['coPumpType'])->orderBy('id', 'DESC')->get();
            $volumetricsValuesASC = isi_6595_EntryPumpTest::where('fldpno', '=', $request['coPumpNo'], 'and', 'fldsno', '=', $request['coPumpType'])->orderBy('id', 'ASC')->get();
            ...
            return view('6595.entry.pumpTestingRD.graphs.vol.g4', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'coPump', 'volumetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g5(Request $request)
    {
        try {
            ...
            return view('6595.entry.pumpTestingRD.graphs.vol.g5', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'coPump', 'volumetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g6(Request $request)
    {
        try {
            ...
            return view('6595.entry.pumpTestingRD.graphs.vol.g6', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'coPump', 'volumetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g7(Request $request)
    {
        try {
            ...
            return view('6595.entry.pumpTestingRD.graphs.vol.g7', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'coPump', 'volumetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g8(Request $request)
    {
        try {
            ...
            return view('6595.entry.pumpTestingRD.graphs.vol.g8', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'coPump', 'volumetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g9(Request $request)
    {
        try {
            ...
            return view('6595.entry.pumpTestingRD.graphs.vol.g9', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'coPump', 'volumetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g10(Request $request)
    {
        try {
            ...
            return view('6595.entry.pumpTestingRD.graphs.vol.g10', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'coPump', 'volumetricsValuesASC']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
            ...
            if ($request->isMethod('post')) {
                if ($request->input('_token')) {
                    ...
                    if ($checkPump) {
                        ...
                        $vol = isi_6595_EntryPumpTest::where('fldpno', '=', $request->input('coPumpNo'))
                    ...
                    } else return redirect()->back()->with('status', ' Pump not exist');
