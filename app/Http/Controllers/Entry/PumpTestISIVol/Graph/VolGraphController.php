...
namespace App\Http\Controllers\Entry\PumpTestISIVol\Graph;
...
class VolGraphController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('entry.pumpTestingISI.graphs.vol.g1', compact('isiGraphScale'));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g1(Request $request)
    {
        try {
            ...
            return view('entry.pumpTestingISI.graphs.vol.g1', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g2(Request $request)
    {
        try {
            ...
            return view('entry.pumpTestingISI.graphs.vol.g2', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g3(Request $request)
    {
        try {
            ...
            return view('entry.pumpTestingISI.graphs.vol.g3', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g4(Request $request)
    {
        try {
            ...
            return view('entry.pumpTestingISI.graphs.vol.g4', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'volumetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g5(Request $request)
    {
        try {
            ...
            return view('entry.pumpTestingISI.graphs.vol.g5', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'volumetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g6(Request $request)
    {
        try {
            ...
            return view('entry.pumpTestingISI.graphs.vol.g6', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'volumetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
