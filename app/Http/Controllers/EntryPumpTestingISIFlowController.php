...
class EntryPumpTestingISIFlowController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('entry.pumpTestingISI.flowmetric', compact(['allPumps', 'allEntryValues', 'entries']));
    }
    ...
    public function view_report_page(Request $request, $pumpNo = null, $pumpName = null)
    {
        try {
            if ($pumpNo != null) {
                ...
                return view('entry.pumpTestingISI.report_flow', compact('pumpData', 'tableData'));
            } else
                return $this->index($request);
        } catch (Exception $ex) {
            return view('entry.pumpTestingISI.report_flow');
        }
    }
