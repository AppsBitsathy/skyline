...
class EntryPumpTestingISIVolController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        try {
            ...
            if (count($request->query()) > 0) {
                ...
                // return $pType;
                return view('entry.pumpTestingISI.volumetric', compact('allPumps', 'entries', 'allEntryValues', 'pType'));
            }
            return view('entry.pumpTestingISI.volumetric', compact('allPumps', 'allEntryValues', 'entries', 'pType'));
        } catch (Exception $ex) {
    ...
    public function view_report_page(Request $request, $pumpNo = null, $pumpName = null)
    {
        try {
            if ($pumpNo != null) {
                ...
                return view('entry.pumpTestingISI.report_vol', compact('pumpData', 'tableData'));
            } else
    ...
    public function create_pdf()
    {
        ...
        $pdf = PDF::loadView('entry.pumpTestingISI.report_vol', compact('pumpData', 'tableData'))->setPaper('a3', 'landscape');
