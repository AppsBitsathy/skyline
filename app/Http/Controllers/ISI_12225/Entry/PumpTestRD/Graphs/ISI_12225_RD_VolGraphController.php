...
namespace App\Http\Controllers\ISI_12225\Entry\PumpTestRD\Graphs;
...
use App\Models\ISI_12225\Entry\isi_12225_EntryPumpTestRDGraphReport;
...
class ISI_12225_RD_VolGraphController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.vol.g1', compact('isiGraphScale'));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g1(Request $request)
    {
        try {
            ...
            $isiGraphScale = isi_12225_Scale::where('fldpmno', '=', $request['coPumpNo'], 'and', 'fldsno', '=', $request['coPumpType'], 'and', 'gtype', '=', 'Volumetric')->orderBy('id', 'DESC')->limit(1)->get();

            $isiGraphScaleValues = $isiGraphScale[0];

            $volumetricsValues = isi_12225_EntryPumpTest::where('fldpmno', '=', $request['coPumpNo'], 'and', 'fldsno', '=', $request['coPumpType'])->orderBy('id', 'DESC')->get();
            ...
            return view('12225.entry.pumpTestingRD.graphs.vol.g1', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g2(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.vol.g2', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g3(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.vol.g3', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g4(Request $request)
    {
        try {
            ...
            $volumetricsValues = isi_12225_EntryPumpTest::where('fldpmno', '=', $request['coPumpNo'], 'and', 'fldsno', '=', $request['coPumpType'])->orderBy('id', 'DESC')->get();
            $volumetricsValuesASC = isi_12225_EntryPumpTest::where('fldpmno', '=', $request['coPumpNo'], 'and', 'fldsno', '=', $request['coPumpType'])->orderBy('id', 'ASC')->get();
            ...
            return view('12225.entry.pumpTestingRD.graphs.vol.g4', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'volumetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g5(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.vol.g5', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'volumetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g6(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.vol.g6', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'volumetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g7(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.vol.g7', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'volumetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g8(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.vol.g8', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'volumetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g9(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.vol.g9', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'volumetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g10(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.vol.g10', compact(['isiGraphScaleValues', 'volumetricsValues', 'pumpValues', 'volumetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function view_report_page(Request $request)
    {
        try {
            ...
            $pumpDetails = isi_12225_MasterPumpType::where('fldsno', '=', $inputs['coPumpType'])->first();
            $entryDetails = isi_12225_EntryPumpTest::where('fldsno', '=', $inputs['coPumpType'])->where('fldpmno', '=', $inputs['coPumpNo'])->get();

            $report = new isi_12225_EntryPumpTestRDGraphReport();
            $report->truncate();
            ...
            if (count($entryDetails) > 0) {
                ...
                foreach ($entryDetails as $entry) {
                    ...
                    $report->fldread = $i++;
                    $report->fldssize = $pumpDetails->flddisize . " X " . $pumpDetails->flddsize;
                    ...
                    $report->fldddlwl = $inputs['reportDecDLWL'];
                    $report->fldodlwl = $inputs['reportObsDLWL'];
                    $report->save();
                }
            }

            $pumpData = isi_12225_EntryPumpTestRDGraphReport::orderBy('id', 'desc')->first();
            $tableData = isi_12225_EntryPumpTestRDGraphReport::all();
            return view('12225.entry.pumpTestingRD.graphs.report', compact('pumpData', 'tableData'));
        } catch (Exception $ex) {
    ...
    public function create_pdf()
    {
        ...
        $pdf = PDF::loadView('12225.entry.pumpTestingRD.graphs.report', compact('pumpData', 'tableData'))->setPaper('a4', 'landscape');
    ...
    public function excel(Request $request)
    {
        ...
        //     $chart = array();
        //     $chart[] =  ['Discharge', 'THead', 'DLWL', 'Input Power', 'Current'];
        ...
        //             $a[] = '-';
        //         }
        //         if (isset($val['fldrdlwl'])) {
        //             $a[] = number_format((float)$val['fldrdlwl'], 5, '.', '');
        //         } else {
        //             $a[] = '-';
        //         }
        //         if (isset($val['fldipow'])) {
        //             $a[] = number_format((float)$val['fldipow'], 5, '.', '');
        //         } else {
        //             $a[] = '-';
        //         }
        ...
        //         new DataSeriesValues(DataSeriesValues::DATASERIES_TYPE_STRING, 'Worksheet!$E$1', null, 1),
        //     ];
        ...
        //         new DataSeriesValues(DataSeriesValues::DATASERIES_TYPE_NUMBER, 'Worksheet!$E$2:$E$' . $tot, null, 4),
        //     ];
        ...
        //     $title = new Title('Pump Performance Testing As Per IS 12225');
