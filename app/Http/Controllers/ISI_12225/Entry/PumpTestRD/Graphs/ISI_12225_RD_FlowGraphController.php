...
class ISI_12225_RD_FlowGraphController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.flow.g1', compact('isiGraphScale'));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g1(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.flow.g1', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g2(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.flow.g2', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g3(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.flow.g3', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g4(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.flow.g4', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'flowmetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g5(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.flow.g5', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'flowmetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g6(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.flow.g6', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'flowmetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g7(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.flow.g7', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'flowmetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g8(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.flow.g8', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'flowmetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g9(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.flow.g9', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'flowmetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
    ...
    public function g10(Request $request)
    {
        try {
            ...
            return view('12225.entry.pumpTestingRD.graphs.flow.g10', compact(['isiGraphScaleValues', 'flowmetricsValues', 'pumpValues', 'flowmetricsValuesASC', 'coPump']));
        } catch (Exception $ex) {
            dd($ex);
        }
    }
            ...
            if ($request->isMethod('post')) {
                if ($request->input('_token')) {
                    ...
                    if ($checkPump) {
                        ...
                        $flow = isi_12225_EntryPumpTest::where('fldpmno', '=', $request->input('coPumpNo'))
