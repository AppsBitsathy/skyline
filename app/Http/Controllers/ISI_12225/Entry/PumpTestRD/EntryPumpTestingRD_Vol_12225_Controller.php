...
class EntryPumpTestingRD_Vol_12225_Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            if (count($request->query()) > 0) {
                ...
                if (sizeof($entries) == 0) return redirect()->route('12225_entryPumpTestRDVol')->with('status', 'Data not exist!');
                return view('12225.entry.pumpTestingRD.volumetric', compact('allPumps', 'entries', 'allEntryValues', 'pType'));
            }
            // return view('12225.entry.pumpTestingRD.volumetric', compact('allPumps'));
            return view('12225.entry.pumpTestingRD.volumetric', compact('allPumps', 'allEntryValues'));
        } catch (Exception $ex) {
    ...
    public function view_report_page(Request $request, $pumpNo = null, $pumpName = null)
    {
        try {
            if ($pumpNo != null) {
                ...
                if ($pumpDetails == null) return redirect()->route('12225_entryPumpTestRDVol')->with('status', 'Pump not exist!');
                $entryDetails = isi_12225_EntryPumpTest::where('fldsno', '=', $pumpNo)->where('fldpmno', '=', $pumpName)->get();
                if (sizeof($entryDetails) == 0) return redirect()->route('12225_entryPumpTestRDVol')->with('status', 'Pump data not exist!');
                ...
                return view('12225.entry.pumpTestingRD.report_vol', compact('pumpData', 'tableData'));
    ...
    public function create_pdf()
    {
        ...
        $pdf = PDF::loadView('12225.entry.pumpTestingRD.report_vol', compact('pumpData', 'tableData'))->setPaper('a3', 'landscape');
    ...
    public function delete(Request $request)
    {
        try {
            ...
            return redirect()->route('12225_entryPumpTestRDVol')->with('status', 'Record Deleted!');
        } catch (Exception $ex) {
            return redirect()->back()->with('status', $ex->__toString());
        }
    }
