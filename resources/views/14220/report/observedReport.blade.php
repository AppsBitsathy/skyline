    ...
    <div class="center-align">
        <div class="pb-1">
            ...
            @isset($startDate)
                ...
                @endisset
            @endisset
            <form action="{{ route('14220_reportPumpObservedFetchDownload') }}" method="post">
                @csrf
        ...
        <div class="row left-align">
            <table class="centered white">
                @isset($pump)
                    <tr>
                        <td><b>HP / kW</b></td>
                        <td><span>{{ $pump->fldhp }}/{{ $pump->fldkw }}</span></td>
                        <td><b>Phase</b></td>
                        <td><span>{{ $pump->fldphase }}</span></td>
                        <td><b>Voltage</b></td>
                        <td><span>{{ $pump->fldvolt }}</span>&nbsp;Volts</td>
                        <td><b>Bore Size</b></td>
                        <td><span>{{ $pump->fldbdia ?? 0 }}</span>&nbsp;mm</td>
                    ...
                    <tr>
                        <td><b>No. of stages</b></td>
                        <td><span>{{ $pump->fldstage }}</span>&nbsp;m</td>
