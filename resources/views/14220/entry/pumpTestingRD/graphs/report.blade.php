...
<body class="grey lighten-2">
    ...
    <div class="center-align">
        <div class="pb-1">
            ...
            <a class="btn waves-effect btn-flat" href="{{ route('14220_entryPumpTestRDVolGraphReportDownload') }}">Click
                here to download</a>
        </div>
        {{-- {{ $pumpData }} --}}
        <div class="row left-align">
            <table class="centered white">
                ...
                <tr>
                    <td class="no-border-left no-border-right"><b>Number of stages</b></td>
                    <td class="no-border-left no-border-right"><span>{{ $pumpData->fldssize }}</span></td>
