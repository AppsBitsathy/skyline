...
<head>
    ...
    <title>Entry - Pump Testing RD - Flowmetric - Report</title>
...
<body class="grey lighten-2">
    ...
    <div class="center-align">
        <div class="pb-1">
            ...
            <a class="btn waves-effect btn-flat" href="{{ route('14220_entryPumpTestRDFlowReportDownload') }}">Click
                here to download</a>
        </div>
            ...
            <div class="row left-align">
                <table class="centered white">
                    <tr>
                        ...
                        <td class="no-border"><span id="dateht">{{ $pumpData->fldht }}</span></td>
