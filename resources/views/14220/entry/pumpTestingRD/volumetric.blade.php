...
<title>Entry - Pump Testing RD - Volumetric</title>
@php
$rId = 221;
$srId = 22;
$rMain = 2;
...
@section('content')
    ...
    <div class="container">
                ...
                <div class="card">
                    <div class="card-body pt-4 pb-2">
                        <div class="row mb-4">
                            ...
                            <div class="col m2 center-align">
                                <form action="{{ route('14220_entryPumpTestRDVolDelete') }}" method="post">
                                    @csrf
                            ...
                            <div class="col m3 center-align">
                                <a class="btn waves-effect waves-light" href="#" disabled name="btnReport"
                        ...
                        <form method="POST" action="{{ route('14220_entryPumpTestRDVolAdd') }}">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col m3 pl-5 pr-5 mt-3">
                                    <span>Correction Head</span>
                                    <input class="input-field" name="chead" id="chead" placeholder="Correction Head"
        ...
        <div id="openModal" class="modal">
            {{-- {{  }} --}}
            <form method="GET" action="{{ route('14220_entryPumpTestRDVol') }}" id="frmOpen">
        ...
        <div id="coOrdinatesModal" class="modal">
            {{-- {{ route('14220entryPumpTestRDVolGraphG1') }} --}}
            <form method="GET" action="{{ route('14220_entryPumpTestRDVolGraphG1') }}" id="frmCoord">
                <div class="modal-content">
    ...
    <script>
        $(document).ready(function() {
            ...
            @isset($entries)
                ...
                $('#obssptimepumpName').val("{{ $entries[0]['fldpno'] }}");
                $('#btnReport').attr("disabled", false);
                var url = "{{ URL::to('14220/entry/pump_testing_rd/volumetric/report/pumpNo/pumpName') }}";
                ...
                @foreach ($entries as $data)
                    ...
                    @if ($data->fldread == 1)
                        ...
                        $('#tblTime').val('{{ round($data->fldtime, 2) }}');
                    ...
                    @else
                        ...
                        html += '<tr id="row' + {{ $data->fldread }} + '">'
                            ...
                            +'<td><input type="text" name="time[]" required value="'+{{ round($data->fldtime, 2) }}+'"></td>'
