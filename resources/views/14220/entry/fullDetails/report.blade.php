...
<body class="grey lighten-2">
    ...
    <div class="center-align">
        <div class="pb-1">
            ...
            <h6>Full Details Report For Submersible Pump As Per IS - 14220</h6>
            <form action="{{ route('14220_entryFullDetailsReportDownload') }}" method="post">
                @csrf
        ...
        <div class="row left-align">
            ...
            <table class="centered white">
                ...
                <tr>
                    ...
                    <td rowspan="2"><b>Discharge (Lps)</b></td>
