...
@section('content')
            ...
            <div id="entry" class="col m12">
                <div class="card">
                    <div class="card-body pt-5 pb-2">
                        <form method="POST" action="{{ route('14220_entryFullDetailsEntry') }}">
                            @csrf
                            <div class="row">
                                <div class="row col m6 ">
                                    ...
                                    <div class="col m12 pl-5 pr-5">
                                        ...
                                        <input class="input-field" type="text" name="eff" placeholder="Efficiency"
                                            required autocomplete="on">
                                    </div>
                                    <div class="col m12 pl-5 pr-5">
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col m6 center-align">
                                <form action="{{ route('14220_entryFullDetailsDelete') }}" method="post">
                                    @csrf
                            ...
                            {{-- <div class="col m4 center-align">
                                <form action="{{ route('14220_entryRoutineTestingReport') }}" method="post" target="blank">
                                    @csrf
            ...
            <form method="POST" action="{{ route('14220_entryFullDetailsEntry') }}">
                ...
                <div class="row">
                    ...
                    <div class="row col m6 ">
                        ...
                        <div class="col m12 pl-5 pr-5">
                            <span>Efficiency (&percnt;)</span>
                            <input class="input-field" type="text" name="eff" id="eff" placeholder="Efficiency" required
                                autocomplete="on">
                        </div>
                        <div class="col m12 pl-5 pr-5">
                            <span>Current (amps)</span>
    ...
    <div id="reportDateModal" class="modal">
        <form method="post" action="{{ route('14220_entryFullDetailsReport') }}" id="frmReportDate" target="blank">
            @csrf
            <div class="modal-content">
...
@section('custom-script')
    <script type="text/javascript">
        ...
        $('#listpumpnowise').change(function(e) {
            ...
            window.location.href = "{{ URL::to('14220/entry/full_details') }}" + "/pumpnowise/" + selectedPno;
        });

        $('#listTypeWise').change(function(e) {
            let selectedPump = e.target.value;
            window.location.href = "{{ URL::to('14220/entry/full_details') }}" + "/pumptypewise/" + selectedPump;
        });

        $('#pumplistall').change(function(e) {
            window.location.href = "{{ URL::to('14220/entry/full_details') }}";
        });
