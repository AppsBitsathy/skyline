...
<title>Entry - Pump Testing ISI - Flowmetric</title>
@php
$rId = 212;
$srId = 21;
$rMain = 2;
...
@section('content')
    ...
    <div class="container">
                ...
                <div class="card">
                    <div class="card-body pt-4 pb-2">
                        <div class="row mb-4">
                            ...
                            <div class="col m2 center-align">
                                <form action="{{ route('14220_entryPumpTestISIFlowDelete') }}" method="post">
                                    @csrf
                        ...
                        <form method="POST" action="{{ route('14220_entryPumpTestISIFlowSubmit') }}">
                            @csrf
                            <div class="row">
        ...
        <div id="openModal" class="modal">
            {{-- {{  }} --}}
            <form method="GET" action="{{ route('14220_entryPumpTestISIFlow') }}" id="frmOpen">
        ...
        <div id="coOrdinatesModal" class="modal">
            {{-- {{ route('entryPumpTestISIFlowGraphG1') }} --}}
            {{-- <form method="GET" action="{{ route('14220_entryPumpTestISIFlowGraphG1') }}" id="frmCoord"> --}}
            <form method="GET" action="{{ route('14220_entryPumpTestISIFlowGraphG1') }}" id="frmCoord">
                <div class="modal-content">
    ...
    <script>
        $(document).ready(function() {
            ...
            @isset($entries)
                ...
                var url = "{{ URL::to('14220/entry/pump_testing_isi/flowmetric/report/pumpNo/pumpName') }}";
