...
<body class="grey lighten-2">
    ...
    <div class="center-align">
        <div class="pb-1">
            ...
            <h6>Routine Test Report For Self-Priming Pump As Per IS - 14220</h6>
            {{-- <h6>Period : </h6> --}}
            <a class="btn waves-effect btn-flat" href="{{ route('14220_entryRoutineTestingReportDownload') }}">Click
                here to download</a>
