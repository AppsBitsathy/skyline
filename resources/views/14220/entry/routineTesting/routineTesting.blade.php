...
@section('content')
            ...
            <div id="entry" class="col m12">
                <div class="card">
                    ...
                    <div class="card-body pt-5 pb-2">
                        <form method="POST" action="{{ route('14220_entryRoutineTestingEntry') }}">
                            @csrf
                            <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col m4 center-align">
                                <form action="{{ route('14220_entryRoutineTestingDelete') }}" method="post">
                                    @csrf
                            ...
                            <div class="col m4 center-align">
                                <form action="{{ route('14220_entryRoutineTestingReport') }}" method="post"
                                    target="blank">
                                    @csrf
    ...
    <div id="reportCustomDate" class="modal">
        <form method="post" action="{{ route('14220_entryRoutineTestingCustomReport') }}" id="frmCustomReportDate"
            target="blank">
            @csrf
            <div class="modal-content">
...
@section('custom-script')
    ...
    <script type="text/javascript">
        ...
        $('#listpumpnowise').change(function(e) {
            ...
            window.location.href = "{{ URL::to('14220/entry/routine_testing') }}" + "/pumpnowise/" + selectedPno;
        });

        $('#listTypeWise').change(function(e) {
            let selectedPump = e.target.value;
            window.location.href = "{{ URL::to('14220/entry/routine_testing') }}" + "/pumptypewise/" +
                selectedPump;
        });

        $('#pumplistall').change(function(e) {
            window.location.href = "{{ URL::to('14220/entry/routine_testing') }}";
        })
