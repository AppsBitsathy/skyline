...
@section('content')
            ...
            <div id="entry" class="col m12">
                <div class="card">
                    <div class="card-body pt-5 pb-2">
                        <form method="POST" action="{{ route('14220_masterPumpDeclaredValuesEntrySubmit') }}">
                            @csrf
                            <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <form id="pumpSelectionForm" method="GET"
                                action="{{ route('14220_masterPumpDeclaredValues') }}">
                                @csrf
                                {{-- {{ method_field('put') }} --}}
    ...
    <div id="editModal" class="modal modal-fixed-footer">
        <div class="modal-content">
            <h4>EDIT</h4>
            <form method="POST" action="{{ route('14220_masterPumpDeclaredValuesUpdate') }}">
                @csrf
                <div class="row">
...
@section('custom-script')
    <script>
        ...
        $('#listPumpTypes').change(function(e) {
            ...
            window.location.href = "{{ URL::to('14220/master/pump_declared_values') }}" + "/" + selectedPump;
        });

        $('#pumpListAll').change(function(e) {
            window.location.href = "{{ URL::to('14220/master/pump_declared_values') }}";
        })
