...
@section('content')
            ...
            <div id="entry" class="col m12">
                <div class="card">
                    ...
                    <div class="card-body pt-5 pb-2">
                        <form method="POST" action="{{ route('8472_masterPumpDeclaredValuesEntrySubmit') }}">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col m4 pl-5 pr-5">
                                    ...
                                    <input class="input-field" type="number" step="any" name="ipow"
                                ...
                                <div class="col m4 pl-5 pr-5">
                                    <span>Self Priming Time</span>
                                    <input class="input-field" name="selfPrTime" placeholder="Self Priming Time" required
                                        autocomplete="on">
                                </div>
                                <div class="col m4 pl-5 pr-5">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <form id="pumpSelectionForm" method="GET"
                                action="{{ route('8472_masterPumpDeclaredValues') }}">
                                @csrf
                                {{-- {{ method_field('put') }} --}}
    ...
    <div id="editModal" class="modal modal-fixed-footer">
        <div class="modal-content">
            <h4>EDIT</h4>
            <form method="POST" action="{{ route('8472_masterPumpDeclaredValuesUpdate') }}">
                @csrf
                <div class="row">
                    ...
                    <div class="col m4 pl-5 pr-5">
                        <span>Input Power (kW)</span>
                        <input class="input-field" type="number" step="any" name="ipow" id="ipow"
                            placeholder="Input Power (kW)" required autocomplete="on">
                    </div>
                    <div class="col m4 pl-5 pr-5">
                        <span>Head Range 1 (m)</span>
                    ...
                    <div class="col m4 pl-5 pr-5">
                        <span>Self Priming Time</span>
                        <input class="input-field" name="selfPrTime" id="selfPrTime" placeholder="Self Priming Time"
                            required autocomplete="on">
                    </div>
                    <div class="col m4 pl-5 pr-5">
                        <span>Frequency (Hz)</span>
...
@section('custom-script')
    <script>
        ...
        function edit(pump) {
            ...
            $('#selfPrTime').val(pump.fldsptime);
        }

        $('#listPumpTypes').change(function(e) {
            let selectedPump = e.target.value;
            window.location.href = "{{ URL::to('8472/master/pump_declared_values') }}" + "/" + selectedPump;
        });

        $('#pumpListAll').change(function(e) {
            window.location.href = "{{ URL::to('8472/master/pump_declared_values') }}";
        })
