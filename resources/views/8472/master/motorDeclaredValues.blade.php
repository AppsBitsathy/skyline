...
@section('content')
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('8472_masterMotorDeclaredValuesStore') }}">
            @csrf
        ...
        <div id="list" class="col s12">
            <div class="card m-3 p-3">
                <div class="row">
                    <form action="{{ route('8472_masterMotorDeclaredValues') }}" method="GET">
                        @csrf
                        <div class="col s12">
    ...
    <div id="editModal" class="modal modal-fixed-footer">
        <div class="modal-content">
            <h4>EDIT</h4>
            <form method="POST" action="{{ route('8472_masterMotorDeclaredValuesUpdate') }}">
                @csrf
                <div class="row">
...
@section('custom-script')
    <script>
        ...
        $('#listMotorTypes').change(function(e) {
            ...
            window.location.href = "{{ URL::to('8472/master/motor_declared_values') }}" + "/" + selectedMotor;
        });

        $('#motorListAll').change(function(e) {
            $('#progress').removeClass('hide');
            window.location.href = "{{ URL::to('8472/master/motor_declared_values') }}";
        })
