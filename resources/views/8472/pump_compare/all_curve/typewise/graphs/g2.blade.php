...
@section('custom-script')
    <script>
        ...
        @foreach ($metricsValues as $met)
            ...
            sample1y = [];
            debugger
            for (let i = 0; i < trace1x.length; i++) { for (let j=trace1x[i]; j <=trace1x[i + 1]; j=j + 0.050) { if (j> 0) {
                var l1, l2, l3, y1;
                ...
                sample2x = [];
                sample2y = [];
                for (let i = 0; i < trace2x.length; i++) { for (let j=trace2x[i]; j <=trace2x[i + 1]; j=j + 0.050) { if (j> 0) {
                    ...
                    sample3x = [];
                    sample3y = [];
                    for (let i = 0; i < trace3x.length; i++) { for (let j=trace3x[i]; j <=trace3x[i + 1]; j=j + 0.050) { if (j>
                        0) {
                        var l1, l2, l3, y1;
