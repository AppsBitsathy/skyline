        ...
        <div class="col s12 m2 l2 card">
            <div class="row center">
                ...
                <div class="col m12 pb-1">
                    {{-- {{ route('8472_entryPumpTestRDFlowGraphReport') }} --}}
                    <form method="post" action="{{ route('8472_entryPumpTestRDFlowGraphReport') }}" target="blank">
                        @csrf
                        ...
                        <input type="hidden" id="reportDecIP" name="reportDecIP" value="{{ $pumpValues['fldip'] }}">
                ...
                <div class="col m12 pb-1">
                    <form action="{{ route('8472_entryPumpTestRDFlowGraphAddPrint') }}" method="post">
                        @csrf
            ...
            <div class="row">
                ...
                <div class="col s12 m6 l6">
                    ...
                    <div class="col s12 m12 l12">
                        ...
                        <div class="col s12 m6 l6">
                            <a onclick="changeLineColor(2,'ipLineColor')" class="btn waves-effect"><i
                                    class="material-icons">done</i></a>
                        </div>
                    </div>
                    <div class="col s12 m12 l12">
...
@section('custom-script')
    ...
    <script>
        ...
        function defaultGraph(visibleX1 = true, visibleX2 = false, visibleX3 = false, selectedXAxis = 'x1') {
            ...
            @foreach ($flowmetricsValuesASC as $flow)
                if (ip < {{ $flow['fldrip'] }}) { ip={{ $flow['fldrip'] }}; thead={{ $flow['fldrthead'] }};
                    curr={{ $flow['fldcurr'] }}; dis={{ $flow['fldrdis'] }}; } @endforeach
            ...
            temp1x[2] = trace1x[trace1x.length - 1];
            temp1y[2] = trace1y[trace1y.length - 1];
            // }
            ...
            let sv = {{ $flowmetricsValuesASC[0]['fldrdis'] / 16.9 }};
            k = 1;
            jj = 0;
            ...
            temp2x[2] = trace2x[trace2x.length - 1];
            temp2y[2] = trace2y[trace2y.length - 1];
            ...
            sv = {{ $flowmetricsValuesASC[0]['fldrdis'] / 16.9 }};
            ...
            temp3x[2] = trace3x[trace3x.length - 1];
            temp3y[2] = trace3y[trace3y.length - 1];
            ...
            temp1x.splice(1, 0, {{ $flowmetricsValues[1]['fldrdis'] }});
            temp1y.splice(1, 0, {{ $flowmetricsValues[1]['fldrthead'] }});
            temp2x.splice(1, 0, {{ $flowmetricsValues[1]['fldrdis'] }});
            temp2y.splice(1, 0, {{ $flowmetricsValues[1]['fldrip'] }});
            temp3x.splice(1, 0, {{ $flowmetricsValues[1]['fldrdis'] }});
            temp3y.splice(1, 0, {{ $flowmetricsValues[1]['fldcurr'] }});
            ...
            @foreach ($flowmetricsValues as $flow)
                // temp1x.push({{ $flow['fldrdis'] }});
                // temp1y.push({{ $flow['fldrthead'] }});
                // temp2x.push({{ $flow['fldrdis'] }});
                // temp2y.push({{ $flow['fldrip'] }});
                // temp3x.push({{ $flow['fldrdis'] }});
                // temp3y.push({{ $flow['fldcurr'] }});
                //
            @endforeach
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/flow/g8/excel') }}" + "?" +
                parameters[1];
        }
        ...
        function callG1() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/flow/g1') }}" + "?" + parameters[1];
        }

        function callG2() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/flow/g2') }}" + "?" + parameters[1];
        }

        function callG3() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/flow/g3') }}" + "?" + parameters[1];
        }

        function callG4() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/flow/g4') }}" + "?" + parameters[1];
        }

        function callG5() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/flow/g5') }}" + "?" + parameters[1];
        }

        function callG6() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/flow/g6') }}" + "?" + parameters[1];
        }

        function callG7() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/flow/g7') }}" + "?" + parameters[1];
        }

        function callG8() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/flow/g8') }}" + "?" + parameters[1];
        }

        function callG9() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/flow/g9') }}" + "?" + parameters[1];
        }

        function callG10() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/flow/g10') }}" + "?" + parameters[1];
        }
