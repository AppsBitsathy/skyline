    ...
    <script>
        ...
        function defaultGraph(visibleX1 = true, visibleX2 = false, visibleX3 = false, selectedXAxis = 'x1') {
            ...
            for (let k = 0; k <= rec - 2; k++) {
                ...
                for (let j = trace1x[k]; j <= trace1x[k + 1]; j = j + 0.050) {
                    w = j - trace1x[k];
                    yp = ((((sk3 * w) + sk2) * w + sk1) * w) + trace1y[k];
                    sample1x.push(j);
                    sample1y.push(yp);
                }
            }
            ...
            for (let k = 0; k <= rec - 2; k++) {
                ...
                for (let j = trace2x[k]; j <= trace2x[k + 1]; j = j + 0.050) {
                    w = j - trace2x[k];
            ...
            for (let k = 0; k <= rec - 2; k++) {
                ...
                sk3 = (tempUse2 - tempUse1) / (6 * h[k]);
                let jj;
                for (let j = i; j <= trace3x[k + 1]; j = j + 0.050) {
                    w = j - trace3x[k];
                    yp = ((((sk3 * w) + sk2) * w + sk1) * w) + trace3y[k];
                    sample3x.push(j);
                    sample3y.push(yp);
                    jj = j;
                }
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/flow/g3/excel') }}" + "?" +
                parameters[1];
        }
