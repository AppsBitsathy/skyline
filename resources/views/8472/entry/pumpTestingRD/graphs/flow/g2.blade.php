...
@section('custom-script')
    ...
    <script>
        ...
        function defaultGraph(visibleX1 = true, visibleX2 = false, visibleX3 = false, selectedXAxis = 'x1') {
            ...
            // End of Input Power Curve Formula
        ...
        function newDutyPoint(globalDischarge, globalTotalHead, globalHeadRange1, globalHeadRange2) {
            ...
            var dpjoinTrace = {
                x: [globalDischarge, 0],
                y: [globalTotalHead, globalTotalHead],
                type: 'scatter',
                hoverinfo: 'none',
                line: {
                    color: '#D62728'
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/flow/g2/excel') }}" + "?" +
                parameters[
                    1];
        }
