    ...
    <script>
        ...
        function defaultGraph(visibleX1 = true, visibleX2 = false, visibleX3 = false, selectedXAxis = 'x1') {
            ...
            for (let i = 0; i <= rec; i++) {
                ...
                temp1x[tempj] = tempUse1;
                temp1y[tempj] = tempUse2;
                tempj = tempj + 2;
            }

            let ii = 1;
            for (let i = ii; i <= tempj - 3; i = ii + 2) {
                temp1x[i] = (temp1x[i - 1] + temp1x[i + 1]) / 2;
                temp1y[i] = (temp1y[i - 1] + temp1y[i + 1]) / 2;
                ii = i;
            }
            ...
            for (let i = 0; i <= rec; i++) {
                ...
                temp2x[tempj] = tempUse1;
                temp2y[tempj] = tempUse2;
                tempj = tempj + 2;
            }

            ii = 1;
            for (let i = ii; i <= tempj - 3; i = ii + 2) {
                temp2x[i] = (temp2x[i - 1] + temp2x[i + 1]) / 2;
                temp2y[i] = (temp2y[i - 1] + temp2y[i + 1]) / 2;
                ii = i;
            }
            ...
            for (let i = 0; i <= rec; i++) {
                ...
                temp3x[tempj] = tempUse1;
                temp3y[tempj] = tempUse2;
                tempj = tempj + 2;
            }

            ii = 1;
            for (let i = ii; i <= tempj - 3; i = ii + 2) {
                temp3x[i] = (temp3x[i - 1] + temp3x[i + 1]) / 2;
                temp3y[i] = (temp3y[i - 1] + temp3y[i + 1]) / 2;
                ii = i;
            }
            ...
            // debugger
            // for (let i = 1; i <= trace1y.length; i++) {
            //     trace1x.splice(i, 1);
            //     trace1y.splice(i, 1);
        ...
        function obsValues(discharge = {{ $pumpValues['flddis'] }}, tHead = {{ $pumpValues['fldthead'] }},
            headR1 = {{ $pumpValues['fldheadr1'] }}, headR2 = {{ $pumpValues['fldheadr2'] }}) {
            // Total Head
            ...
            var traceReplaced8 = {
                x: [0, parseFloat(headRangeTHIntercept2.x).toFixed(2), parseFloat(headRangeTHIntercept2.x).toFixed(
                        2),
            ...
            // Trace 7 Reassign
            var traceReplaced7 = {
                x: [0, parseFloat(headRangeTHIntercept.x).toFixed(2), parseFloat(headRangeTHIntercept.x).toFixed(
                    2)],
                y: [headR1, parseFloat(headRangeTHIntercept.y).toFixed(2),
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/flow/g7/excel') }}" + "?" +
                parameters[
                    1];
        }
