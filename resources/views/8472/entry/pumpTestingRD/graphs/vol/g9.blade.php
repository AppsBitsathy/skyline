...
@section('custom-script')
    ...
    <script>
        ...
        function defaultGraph(visibleX1 = true, visibleX2 = false, visibleX3 = false, selectedXAxis = 'x1') {
            ...
            let sv = {{ $volumetricsValuesASC[0]['fldrdis'] / 25.5 }};
            ...
            sv = {{ $volumetricsValuesASC[0]['fldrdis'] / 25.5 }};
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/vol/g9/excel') }}" + "?" + parameters[
                1];
        }
