        ...
        <div class="col s12 m2 l2 card">
            <div class="row center">
                ...
                <div class="col m12 pb-1">
                    {{-- {{ route('8472_entryPumpTestRDVolGraphReport') }} --}}
                    <form method="post" action="{{ route('8472_entryPumpTestRDVolGraphReport') }}" target="blank">
                        @csrf
                ...
                <div class="col m12 pb-1">
                    <form action="{{ route('8472_entryPumpTestRDVolGraphAddPrint') }}" method="post">
                        @csrf
...
@section('custom-script')
    ...
    <script>
        ...
        function defaultGraph(visibleX1 = true, visibleX2 = false, visibleX3 = false, selectedXAxis = 'x1') {
            ...
            @foreach ($volumetricsValuesASC as $vol)
                if (ip < {{ $vol['fldrip'] }}) { ip={{ $vol['fldrip'] }}; thead={{ $vol['fldrthead'] }};
                    curr={{ $vol['fldcurr'] }}; dis={{ $vol['fldrdis'] }}; } @endforeach
            ...
            let sv = {{ $volumetricsValuesASC[0]['fldrdis'] / 16.9 }};
            k = 1;
            jj = 0;
            ...
            sv = {{ $volumetricsValuesASC[0]['fldrdis'] / 16.9 }};
            ...
            temp1x.splice(1, 0, {{ $volumetricsValues[1]['fldrdis'] }});
            temp1y.splice(1, 0, {{ $volumetricsValues[1]['fldrthead'] }});
            temp2x.splice(1, 0, {{ $volumetricsValues[1]['fldrdis'] }});
            temp2y.splice(1, 0, {{ $volumetricsValues[1]['fldrip'] }});
            temp3x.splice(1, 0, {{ $volumetricsValues[1]['fldrdis'] }});
            temp3y.splice(1, 0, {{ $volumetricsValues[1]['fldcurr'] }});
            ...
            @foreach ($volumetricsValues as $vol)
                // temp1x.push({{ $vol['fldrdis'] }});
                // temp1y.push({{ $vol['fldrthead'] }});
                // temp2x.push({{ $vol['fldrdis'] }});
                // temp2y.push({{ $vol['fldrip'] }});
                // temp3x.push({{ $vol['fldrdis'] }});
                // temp3y.push({{ $vol['fldcurr'] }});
                //
            @endforeach
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/vol/g8/excel') }}" + "?" + parameters[
                1];
        }
        ...
        function callG1() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/vol/g1') }}" + "?" + parameters[1];
        }

        function callG2() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/vol/g2') }}" + "?" + parameters[1];
        }

        function callG3() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/vol/g3') }}" + "?" + parameters[1];
        }

        function callG4() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/vol/g4') }}" + "?" + parameters[1];
        }

        function callG5() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/vol/g5') }}" + "?" + parameters[1];
        }

        function callG6() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/vol/g6') }}" + "?" + parameters[1];
        }

        function callG7() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/vol/g7') }}" + "?" + parameters[1];
        }

        function callG8() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/vol/g8') }}" + "?" + parameters[1];
        }

        function callG9() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/vol/g9') }}" + "?" + parameters[1];
        }

        function callG10() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/vol/g10') }}" + "?" + parameters[1];
        }
