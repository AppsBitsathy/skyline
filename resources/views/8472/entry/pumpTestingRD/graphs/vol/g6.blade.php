...
@section('custom-script')
    ...
    <script>
        ...
        function defaultGraph(visibleX1 = true, visibleX2 = false, visibleX3 = false, selectedXAxis = 'x1') {
            ...
            let n = rec - 2;
            let sv = {{ $volumetricsValuesASC[0]['fldrdis'] / 2.99 }};
            ...
            rec = trace2x.length;
            n = rec - 2;
            sv = {{ $volumetricsValuesASC[0]['fldrdis'] / 2.99 }};
        ...
        function obsValues(discharge = {{ $pumpValues['flddis'] }}, tHead = {{ $pumpValues['fldthead'] }}, headR1 =
            ...
            var trace6 = {
                ...
                y: [0, {{ $isiGraphScaleValues['yaxis2'] * 20 }}],
                name: 'Q vs IP',
                yaxis: 'y2',
                type: 'scatter'
            };
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/vol/g6/excel') }}" + "?" + parameters[
                1];
        }
