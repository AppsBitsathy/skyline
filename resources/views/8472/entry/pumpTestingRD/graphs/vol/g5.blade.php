...
@section('custom-script')
    ...
    <script>
        ...
        function defaultGraph(visibleX1 = true, visibleX2 = false, visibleX3 = false, selectedXAxis = 'x1') {
            ...
            let n = rec - 2;
            let sv = {{ $volumetricsValuesASC[0]['fldrdis'] / 7.5 }};
            ...
            rec = trace2x.length;
            n = rec - 2;
            sv = {{ $volumetricsValuesASC[0]['fldrdis'] / 7.5 }};
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('8472/entry/pump_testing_rd/graphs/vol/g5/excel') }}" + "?" + parameters[
                1];
        }
