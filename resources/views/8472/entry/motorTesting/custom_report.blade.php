...
<body class="grey lighten-2">
    ...
    <div class="center-align">
        <div class="pb-1">
            ...
            <h6>Motor Performance Test As Per IS - 8472</h6>
            <a class="btn waves-effect btn-flat" href="{{ route('8472_entryMotorTestingCustomReportDownload') }}">Click
                here to download</a>
            <h6>Period: {{ $tableData[0]->fldfdate }} to {{ $tableData[0]->fldtdate }}</h6>
        </div>
        ...
        <div class="row left-align">
            ...
            <table class="centered white">
                ...
                <tr>
                    ...
                    <td colspan="4"><b>Performance Values</b></td>
