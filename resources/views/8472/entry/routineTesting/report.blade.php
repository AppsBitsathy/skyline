...
<body class="grey lighten-2">
    ...
    <div class="center-align">
        <div class="pb-1">
            ...
            {{-- <h6>Period : </h6> --}}
            <a class="btn waves-effect btn-flat" href="{{ route('8472_entryRoutineTestingReportDownload') }}">Click
                here to download</a>
            ...
            @isset($tableData)
                <table class="centered white">
                    <tr>
                        ...
                        <td class="no-border"><span id="">{{ $tableData[0]->fldvolt }} <b>V</b></span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="no-border"><span id="">{{ $tableData[0]->fldmcurr }} <b>A</b></span>
                        </td>
                        <td class="no-border"><b>Input Power</b></td>
                        <td class="no-border"><span id="">{{ $tableData[0]->fldip }} <b>kW</b></span>
                        </td>
                    </tr>
                    <tr>
