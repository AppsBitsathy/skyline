...
@section('content')
    ...
    <div class="container">
                ...
                <div class="card">
                    <div class="card-body pt-4 pb-2">
                        <div class="row mb-4">
                            ...
                            <div class="col m2 center-align">
                                <form action="{{ route('8472_entryPumpTestISIFlowDelete') }}" method="post">
                                    @csrf
                        ...
                        <form method="POST" action="{{ route('8472_entryPumpTestISIFlowSubmit') }}">
                            @csrf
                            <div class="row">
        ...
        <div id="openModal" class="modal">
            {{-- {{  }} --}}
            <form method="GET" action="{{ route('8472_entryPumpTestISIFlow') }}" id="frmOpen">
        ...
        <div id="reportSPtimeModal" class="modal">
            <form method="POST" action="{{ route('8472_entryPumpTestISIFlowViewReport') }}" target="blank">
                @csrf
                <div class="modal-content">
        ...
        <div id="coOrdinatesModal" class="modal">
            ...
            <form method="GET" action="{{ route('8472_entryPumpTestISIFlowGraphG1') }}" id="frmCoord">
                <div class="modal-content">
