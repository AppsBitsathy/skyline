        ...
        <div class="col s12 m2 l2 card">
            <div class="row center">
                ...
                <div class="col m12 pb-1">
                    <form action="{{ route('8472_entryPumpTestISIFlowGraphAddPrint') }}" method="post">
                        @csrf
...
@section('custom-script')
    <script>
        ...
        function callG1() {
            ...
            window.location.href = "{{ URL::to('8472/entry/pump_testing_isi/graphs/flow/g1') }}" + "?" + parameters[1];
        }

        function callG2() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_isi/graphs/flow/g2') }}" + "?" + parameters[1];
        }

        function callG3() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_isi/graphs/flow/g3') }}" + "?" + parameters[1];
        }

        function callG4() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_isi/graphs/flow/g4') }}" + "?" + parameters[1];
        }

        function callG5() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_isi/graphs/flow/g5') }}" + "?" + parameters[1];
        }

        function callG6() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('8472/entry/pump_testing_isi/graphs/flow/g6') }}" + "?" + parameters[1];
        }
