...
@section('content')
    ...
    <div class="container">
                ...
                <div class="card">
                    <div class="card-body pt-4 pb-2">
                        <div class="row mb-4">
                            ...
                            <div class="col m2 center-align">
                                <form action="{{ route('8472_entryPumpTestISIVolDelete') }}" method="post">
                                    @csrf
                        ...
                        <form method="POST" action="{{ route('8472_entryPumpTestISIVolAdd') }}">
                            @csrf
                            <div class="row">
        ...
        <div id="openModal" class="modal">
            {{-- {{  }} --}}
            <form method="GET" action="{{ route('8472_entryPumpTestISIVol') }}" id="frmOpen">
        ...
        <div id="reportSPtimeModal" class="modal">
            <form method="POST" action="{{ route('8472_entryPumpTestISIVolViewReport') }}" target="blank">
                @csrf
                <div class="modal-content">
        ...
        <div id="coOrdinatesModal" class="modal">
            ...
            <form method="GET" action="{{ route('8472_entryPumpTestISIVolGraphG1') }}" id="frmCoord">
                <div class="modal-content">
