            ...
            <div class="col m12">
                <div class="card">
                    <div class="card-body pt-3 pb-2 center light-blue-text">
                        ...
                        <h4>As Per IS 12225</h4>
                        <h5>Version 2.0</h5>
                        <h6 class="black-text">The copy right of this product is licensed to skyline softwares.</h6>
                        as in vb:
                        <h6 class="black-text">The copy right of this product is licensed to Mahendra Pumps (p) ltd.</h6>
                        <h6>Coimbatore.</h6>
                    </div>
                </div>
            </div>
