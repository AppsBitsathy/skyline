                    ...
                    <div class="card-body pt-3 pb-2">
                        ...
                        <div class="p-3">
                            ...
                            <ol>
                                ...
                                <li>
                                    ...
                                    <span class="materialize-red-text">FILE</span> button, select the <span
                                        class="materialize-red-text">12225.lsp</span> file and
                                    click <span class="materialize-red-text">OPEN</span>. Click <span
                                        class="materialize-red-text">LOAD</span> button and Type
                                    <span class="materialize-red-text">12225</span> in command line and press <span
                                ...
                                <li>
                                    ...
                                    option i.e., TotalHead, DLWL, Input Power or Current. Click <span
                                ...
                                <li>
                                    The same procedure can be followed for DLWL, Input Power and Current.
                                </li>
                                <li>
                            ...
                            <ol>
                                ...
                                <li>This report is used to find the Maximum & Minimum values for TotalHead, DLWL, Input
                            ...
                            <h5><u>Pump Comparison (DLWL - All Types)</u></h5>
                            <ol>
                                <li>
                                    <dt>To open "Individual curves Comparison" for DLWL for all pump types
                                        click</dt>
                                    <dd>Pump Comparison -> Individual Curve Comparison -> All Types -> DLWL
                                    </dd>
                                </li>
                                <li>The unit options frame will be displayed. Select the required unit and click <span
                                        class="materialize-red-text">OK</span> button.
                            ...
                            <h5><u>Pump Comparison (DLWL - Type-wise)</u></h5>
                            <ol>

                                <li>
                                    <dt>To open “Individual curves Comparison” for DLWL for single pump type click</dt>
                                    <dd>Pump Comparison -> Individual Curve Comparison -> Type wise -> DLWL</dd>
                                </li>
