            ...
            <div class="col m12">
                <div class="card">
                    <div class="card-body pt-3 pb-2">
                        <h4 class="center light-blue-text text-darken-1">Working Procedure for Monoblock Pumps (IS:9079)
                        </h4>
                        <div class="p-3">
                            ...
                            <ol>
                                ...
                                <li>
                                    ...
                                    <span class="materialize-red-text">FILE</span> button, select the <span
                                        class="materialize-red-text">9079.lsp</span> file and
                                    click <span class="materialize-red-text">OPEN</span>. Click <span
                                        class="materialize-red-text">LOAD</span> button and Type
                                    <span class="materialize-red-text">9079</span> in command line and press <span
                                ...
                                <li>
                                    If Duty point values and Headrange values are not correctly fixed and if wrong values
                                    are
                                ...
                                <li>
                                    ...
                                    option i.e., TotalHead, Overall Efficiency or Current. Click <span
                                ...
                                <li>
                                    The same procedure can be followed for Overall Efficiency and Current.
                                </li>
                                <li>
                            ...
                            <ol>
                                ...
                                <li>This report is used to find the Maximum & Minimum values for TotalHead, Overall
                                    Efficiency and Current in between two dates for all types with corresponding Pump
                                    numbers.</li>
                            ...
                            <h5><u>Pump Comparison (Overall Efficiency - All Types)</u></h5>
                            <ol>
                                <li>
                                    <dt>To open "Individual curves Comparison" for Overall Efficiency for all pump types
                                        click</dt>
                                    <dd>Pump Comparison -> Individual Curve Comparison -> All Types -> Overall Efficiency
                                    </dd>
                                </li>
                                <li>The unit options frame will be displayed. Select the required unit and click <span
                                        class="materialize-red-text">OK</span> button.
                            ...
                            <h5><u>Pump Comparison (Overall Efficiency - Type-wise)</u></h5>
                            <ol>
                                <li>
                                    <dt>To open "Individual curves Comparison" for Overall Efficiency single pump types
                                        click</dt>
                                    <dd>Pump Comparison -> Individual Curve Comparison -> Type wise -> Overall Efficiency
                                    </dd>
                                </li>
                                <li>Select the pump type from the top right corner Combo box</li>
                                <li>The unit options frame will be displayed. Select the required unit and click <span
