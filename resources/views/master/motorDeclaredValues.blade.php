...
@section('content')
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('masterMotorDeclaredValuesStore') }}">
            @csrf
            <div id="entry" class="col s12">
                <div class="card p-5 m-3">
                    <div class="row">
                        <div class="input-field col s6">
                            <input placeholder="Enter Serial Number" name="serialNo" type="text" class="validate"
                                required>
                        ...
                        <div class="input-field col s6">
                            <input placeholder="Enter Drum Radius (m)" name="drumRadius" type="text" class="validate"
                                required>
                            <label for="drumRadius">Drum Radius (m)</label>
                        </div>
                        <div class="input-field col s6">
                            <input placeholder="Enter Belt Thickness (m)" name="beltThickness" type="text"
                ...
                <table class="responsive-table white">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th>Power (kW)</th>
                            <th>Rated Full Load Speed (rpm)</th>
                            <th>Length of the Arm (m)</th>
                        </tr>
                    </thead>
    ...
    <div id="editModal" class="modal modal-fixed-footer">
        <div class="modal-content">
            <h4>EDIT</h4>
            <form method="POST" action="{{ route('masterMotorDeclaredValuesUpdate') }}">
                @csrf
                <div class="row">
                    <input type="hidden" name="id" id="id">
                    <div class="input-field col s6">
                        <input placeholder="Enter Serial Number" id="serialNo" name="serialNo" type="text"
                            class="validate" required>
                        <label for="serialNo">Serial Number</label>
                    </div>
                    <div class="input-field col s6">
                        <input placeholder="Enter Motor Type" id="motorType" name="motorType" type="text"
                            class="validate" required>
                        <label for="motorType">Motor Type</label>
                    </div>
                    <div class="input-field col s6">
                        <input placeholder="Enter Drum Radius (m)" id="drumRadius" name="drumRadius" type="text"
                            class="validate" required>
                        <label for="drumRadius">Drum Radius (m)</label>
                    </div>
                    <div class="input-field col s6">
                        <input placeholder="Enter Belt Thickness (m)" id="beltThickness" name="beltThickness" type="text"
                            class="validate" required>
                        <label for="beltThickness">Belt Thickness (m)</label>
                    </div>
                    <div class="input-field col s6">
                        <input placeholder="Enter Rated Voltage (Volts)" id="ratedVoltage" name="ratedVoltage" type="text"
                            class="validate" required>
                        <label for="ratedVoltage">Rated Voltage (Volts)</label>
                    </div>
                    <div class="input-field col s6">
                        <input placeholder="Enter Power (kW)" id="power" name="power" type="text" class="validate"
                            required>
                        <label for="power">Power (kW)</label>
                    </div>
                    <div class="input-field col s6">
                        <input placeholder="Enter Rated Full Load Speed (rpm)" id="ratedFullLoadSpeed"
                            name="ratedFullLoadSpeed" type="text" class="validate" required>
                        <label for="ratedFullLoadSpeed">Rated Full Load Speed (rpm)</label>
                    </div>
                    <div class="input-field col s6">
                        <input placeholder="Enter Length of the Arm (m)" id="lengthOfArm" name="lengthOfArm" type="text"
                            class="validate" required>
                        <label for="lengthOfArm">Length of the Arm (m)</label>
                    </div>
                </div>
...
@section('custom-script')
    <script>
        ...
        function edit(motor) {
            ...
            // $('#motorType').attr('disabled', 'disabled')
        }

        $('#listMotorTypes').change(function(e) {
            let selectedMotor = e.target.value;
            window.location.href = "{{ URL::to('9079/master/motor_declared_values') }}" + "/" + selectedMotor;
        });

        $('#motorListAll').change(function(e) {
            window.location.href = "{{ URL::to('9079/master/motor_declared_values') }}";
        })
