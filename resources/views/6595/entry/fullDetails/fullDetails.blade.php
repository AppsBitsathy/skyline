...
@section('content')
            ...
            <div id="entry" class="col m12">
                <div class="card">
                    ...
                    <div class="card-body pt-5 pb-2">
                        <form method="POST" action="{{ route('6595_entryFullDetailsEntry') }}">
                            @csrf
                            <div class="row">
                                <div class="row col m6 ">
                                    ...
                                    <div class="col m12 pl-5 pr-5">
                                        <span>Efficiency (&percnt;)</span>
                                        <input class="input-field" type="text" name="ipow" placeholder="Efficiency"
                                            required autocomplete="on">
                                    </div>
                                    <div class="col m12 pl-5 pr-5">
                                        <span>Power (kW)</span>
                                        <input class="input-field" type="text" name="curr" placeholder="Power" required
                                            autocomplete="on">
                                    </div>
                                </div>
                                <div class="row col m6">
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col m6 center-align">
                                <form action="{{ route('6595_entryFullDetailsDelete') }}" method="post">
                                    @csrf
                            ...
                            {{-- <div class="col m4 center-align">
                                <form action="{{ route('6595_entryRoutineTestingReport') }}" method="post" target="blank">
                                    @csrf
            ...
            <form method="POST" action="{{ route('6595_entryFullDetailsEntry') }}">
                ...
                <div class="row">
                    ...
                    <div class="row col m6 ">
                        ...
                        <div class="col m12 pl-5 pr-5">
                            <span>Efficiency (&percnt;)</span>
                            <input class="input-field" type="text" name="ipow" id="ipow" placeholder="Efficiency"
                                required autocomplete="on">
                        </div>
                        <div class="col m12 pl-5 pr-5">
                            <span>Power (kW)</span>
                            <input class="input-field" type="text" name="curr" id="curr" placeholder="Power" required
                                autocomplete="on">
                        </div>
                    </div>
                    <div class="row col m6">
    ...
    <div id="reportDateModal" class="modal">
        <form method="post" action="{{ route('6595_entryFullDetailsReport') }}" id="frmReportDate" target="blank">
            @csrf
            <div class="modal-content">
...
@section('custom-script')
    <script type="text/javascript">
        ...
        function edit(data) {
            ...
            $('#ipow').val(data.fldoeff);
            $('#curr').val(data.fldcur);
        ...
        $('#listpumpnowise').change(function(e) {
            ...
            window.location.href = "{{ URL::to('6595/entry/full_details') }}" + "/pumpnowise/" + selectedPno;
        });

        $('#listTypeWise').change(function(e) {
            let selectedPump = e.target.value;
            window.location.href = "{{ URL::to('6595/entry/full_details') }}" + "/pumptypewise/" + selectedPump;
        });

        $('#pumplistall').change(function(e) {
            window.location.href = "{{ URL::to('6595/entry/full_details') }}";
        });
