...
@section('content')
    ...
    <div class="container">
                ...
                <div class="card">
                    <div class="card-body pt-4 pb-2">
                        <div class="row mb-4">
                            ...
                            <div class="col m2 center-align">
                                <form action="{{ route('6595_entryPumpTestRDVolDelete') }}" method="post">
                                    @csrf
                        ...
                        <form method="POST" action="{{ route('6595_entryPumpTestRDVolAdd') }}">
                            @csrf
                            <div class="row">
        ...
        <div id="openModal" class="modal">
            {{-- {{  }} --}}
            <form method="GET" action="{{ route('6595_entryPumpTestRDVol') }}" id="frmOpen">
        ...
        <div id="coOrdinatesModal" class="modal">
            {{-- {{ route('6595_entryPumpTestRDVolGraphG1') }} --}}
            <form method="GET" action="{{ route('6595_entryPumpTestRDVolGraphG1') }}" id="frmCoord">
                <div class="modal-content">
    ...
    <script>
        $(document).ready(function() {
            ...
            @isset($entries)
                ...
                var url = "{{ URL::to('6595/entry/pump_testing_rd/volumetric/report/pumpNo/pumpName') }}";
