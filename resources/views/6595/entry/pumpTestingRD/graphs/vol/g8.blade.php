        ...
        <div class="col s12 m2 l2 card">
            <div class="row center">
                ...
                <div class="col m12 pb-1">
                    <form method="post" action="{{ route('6595_entryPumpTestRDVolGraphReport') }}" target="blank">
                        @csrf
                ...
                <div class="col m12 pb-1">
                    <form action="{{ route('6595_entryPumpTestRDVolGraphAddPrint') }}" method="post">
                        @csrf
    ...
    <script>
        ...
        function defaultGraph(visibleX1 = true, visibleX2 = false, visibleX3 = false, selectedXAxis = 'x1') {
            ...
            @foreach ($volumetricsValuesASC as $vol)
                if (oeff < {{ $vol['fldoeff'] }}) { oeff={{ $vol['fldoeff'] }}; thead={{ $vol['fldrthead'] }};
                    curr={{ $vol['fldrip'] }}; dis={{ $vol['fldrdis'] }}; } @endforeach
            ...
            temp2y.splice(1, 0, {{ $volumetricsValues[1]['fldoeff'] }});
            temp3x.splice(1, 0, {{ $volumetricsValues[1]['fldrdis'] }});
            temp3y.splice(1, 0, {{ $volumetricsValues[1]['fldrip'] }});
            ...
            @foreach ($volumetricsValues as $vol)
                ...
                // temp2y.push({{ $vol['fldoeff'] }});
                // temp3x.push({{ $vol['fldrdis'] }});
                // temp3y.push({{ $vol['fldrip'] }});
                //
            @endforeach
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('6595/entry/pump_testing_rd/graphs/vol/g8/excel') }}" + "?" + parameters[
                1];
        }
        ...
        function callG1() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('6595/entry/pump_testing_rd/graphs/vol/g1') }}" + "?" + parameters[1];
        }

        function callG2() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('6595/entry/pump_testing_rd/graphs/vol/g2') }}" + "?" + parameters[1];
        }

        function callG3() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('6595/entry/pump_testing_rd/graphs/vol/g3') }}" + "?" + parameters[1];
        }

        function callG4() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('6595/entry/pump_testing_rd/graphs/vol/g4') }}" + "?" + parameters[1];
        }

        function callG5() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('6595/entry/pump_testing_rd/graphs/vol/g5') }}" + "?" + parameters[1];
        }

        function callG6() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('6595/entry/pump_testing_rd/graphs/vol/g6') }}" + "?" + parameters[1];
        }

        function callG7() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('6595/entry/pump_testing_rd/graphs/vol/g7') }}" + "?" + parameters[1];
        }

        function callG8() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('6595/entry/pump_testing_rd/graphs/vol/g8') }}" + "?" + parameters[1];
        }

        function callG9() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('6595/entry/pump_testing_rd/graphs/vol/g9') }}" + "?" + parameters[1];
        }

        function callG10() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('6595/entry/pump_testing_rd/graphs/vol/g10') }}" + "?" + parameters[1];
        }
