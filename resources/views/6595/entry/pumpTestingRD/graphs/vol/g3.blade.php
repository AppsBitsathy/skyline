    ...
    <script>
        ...
        function defaultGraph(visibleX1 = true, visibleX2 = false, visibleX3 = false, selectedXAxis = 'x1') {
            ...
            for (let k = 0; k <= rec - 2; k++) {
                ...
                for (let j = trace2x[k]; j <= trace2x[k + 1]; j = j + 0.001) {
                    w = j - trace2x[k];
            ...
            for (let k = 0; k <= rec - 2; k++) {
                ...
                sk3 = (tempUse2 - tempUse1) / (6 * h[k]);
                let jj;
                for (let j = i; j <= trace3x[k + 1]; j = j + 0.001) {
                    w = j - trace3x[k];
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('6595/entry/pump_testing_rd/graphs/vol/g3/excel') }}" + "?" + parameters[
                1];
        }
