            ...
            <div class="row center">
                ...
                <div class="col m12 pb-1">
                    ...
                    <form method="post" action="{{ route('6595_entryPumpTestRDVolGraphReport') }}" target="blank">
                        ...
                        <input type="hidden" id="reportDecCurr" name="reportDecCurr" value="{{ $pumpValues['fldmcurr'] }}">
...
@section('custom-script')
    ...
    <script>
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('6595/entry/pump_testing_rd/graphs/vol/g2/excel') }}" + "?" + parameters[
                1];
        }
