...
@section('content')
            ...
            <div id="entry" class="col m12">
                <div class="card">
                    ...
                    <div class="card-body pt-5 pb-2">
                        <form method="POST" action="{{ route('6595_entryRoutineTestingEntry') }}">
                            @csrf
                            <div class="row">
                                ...
                                <div id="typetestreading">
                                    ...
                                    <div class="col m3 pl-5 pr-5">
                                        ...
                                        <input class="input-field" name="oeff" id="eoeff"
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col m4 center-align">
                                <form action="{{ route('6595_entryRoutineTestingDelete') }}" method="post">
                                    @csrf
            ...
            <form method="POST" action="{{ route('6595_entryRoutineTestingEntry') }}">
                ...
                <div class="row">
                    ...
                    <div id="edittypetestreading">
                        ...
                        <div class="col m3 pl-5 pr-5">
                            <span>Overall Efficiency (&percnt;)</span>
                            <input class="input-field" name="oeff" id="oeff" placeholder="Overall Efficiency (&percnt;)"
                                autocomplete="on">
                        </div>
                        <div class="col m3 pl-5 pr-5">
                            <span>Total Head (m)</span>
    ...
    <div id="reportCustomDate" class="modal">
        <form method="post" action="{{ route('6595_entryRoutineTestingCustomReport') }}" id="frmCustomReportDate"
            target="blank">
            @csrf
            <div class="modal-content">
...
@section('custom-script')
    ...
    <script type="text/javascript">
        ...
        $('#listpumpnowise').change(function(e) {
            ...
            window.location.href = "{{ URL::to('6595/entry/routine_testing') }}" + "/pumpnowise/" + selectedPno;
        });

        $('#listTypeWise').change(function(e) {
            let selectedPump = e.target.value;
            window.location.href = "{{ URL::to('6595/entry/routine_testing') }}" + "/pumptypewise/" +
                selectedPump;
        });

        $('#pumplistall').change(function(e) {
            window.location.href = "{{ URL::to('6595/entry/routine_testing') }}";
        })
