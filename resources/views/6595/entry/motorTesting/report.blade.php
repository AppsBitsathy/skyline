...
<head>
    ...
    <title>Entry - Motor Testing - Report</title>
...
<body class="grey lighten-2">
    ...
    <div class="center-align">
        <div class="pb-1">
            ...
            <h6>Centrifugal Pump Motor Performance Test As Per IS - 6595</h6>
            <a class="btn waves-effect btn-flat" href="{{ route('6595_entryMotorTestingReportDownload') }}">Click here
                to download</a>
        </div>
        ...
        <div class="row left-align">
            ...
            <table class="centered white">
                <tr>
                    ...
                    <td rowspan="2"><b>Casing Pressure Test & Balancing</b></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="25" class="no-border-left no-border-right"></td>
                </tr>
                <tr>
                    <td colspan="13" class="no-border"><b>Tested By</b></td>
                    <td colspan="12" class="no-border"><b>Checked By</b></td>
                </tr>
                <tr>
                    <td colspan="25" class="no-border"></td>
                </tr>
                <tr>
                    <td colspan="25" class="no-border"></td>
                </tr>
