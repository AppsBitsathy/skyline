    ...
    <script>
        ...
        function obsValues(discharge = {{ $pumpValues['flddis'] }}, tHead = {{ $pumpValues['fldthead'] }}, headR1 =
            ...
            if (headRangeIIntercept.y > headRangeIIntercept2.y) {
                $('#observedIP').html(parseFloat(headRangeIIntercept.y).toFixed(2));
                ...
                $('#observedIP').html(parseFloat(headRangeIIntercept2.y).toFixed(2));
            ...
            // Current PieChart
            var data = [{
                values: [{{ $pumpValues['fldmcurr'] }}, $('#observedIP').html()],
                labels: ['Declared', 'Observed'],
                type: 'pie',
                text: [{{ $pumpValues['fldmcurr'] }}, $('#observedIP').html()],
                textinfo: 'text',
                hoverinfo: 'none',
                marker: {
                    colors: ['red', 'limegreen']
