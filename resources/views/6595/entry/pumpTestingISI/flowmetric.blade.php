...
@section('content')
    ...
    <div class="container">
                ...
                <div class="card">
                    <div class="card-body pt-4 pb-2">
                        <div class="row mb-4">
                            ...
                            <div class="col m2 center-align">
                                <form action="{{ route('6595_entryPumpTestISIFlowDelete') }}" method="post">
                                    @csrf
                        ...
                        <form method="POST" action="{{ route('6595_entryPumpTestISIFlowSubmit') }}">
                            @csrf
                            <div class="row">
        ...
        <div id="openModal" class="modal">
            {{-- {{  }} --}}
            <form method="GET" action="{{ route('6595_entryPumpTestISIFlow') }}" id="frmOpen">
        ...
        <div id="coOrdinatesModal" class="modal">
            ...
            <form method="GET" action="{{ route('6595_entryPumpTestISIFlowGraphG1') }}" id="frmCoord">
                <div class="modal-content">
    ...
    <script>
        $(document).ready(function() {
            ...
            @isset($entries)
                ...
                var url = "{{ URL::to('6595/entry/pump_testing_isi/flowmetric/report/pumpNo/pumpName') }}";
