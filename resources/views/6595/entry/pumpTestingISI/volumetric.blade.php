...
@section('content')
    ...
    <div class="container">
                ...
                <div class="card">
                    <div class="card-body pt-4 pb-2">
                        <div class="row mb-4">
                            ...
                            <div class="col m2 center-align">
                                <form action="{{ route('6595_entryPumpTestISIVolDelete') }}" method="post">
                                    @csrf
                        ...
                        <form method="POST" action="{{ route('6595_entryPumpTestISIVolAdd') }}">
                            @csrf
                            <div class="row">
        ...
        <div id="openModal" class="modal">
            {{-- {{  }} --}}
            <form method="GET" action="{{ route('6595_entryPumpTestISIVol') }}" id="frmOpen">
        ...
        {{-- <div id="reportSPtimeModal" class="modal">
            <form method="POST" action="{{ route('6595_entryPumpTestISIVolViewReport') }}" target="blank">
                @csrf
                <div class="modal-content">
        ...
        <div id="coOrdinatesModal" class="modal">
            {{-- {{ route('6595_entryPumpTestISIVolGraphG1') }} --}}
            <form method="GET" action="{{ route('6595_entryPumpTestISIVolGraphG1') }}" id="frmCoord">
                <div class="modal-content">
    ...
    <script>
        $(document).ready(function() {
            ...
            @isset($entries)
                ...
                var url = "{{ URL::to('6595/entry/pump_testing_isi/volumetric/report/pumpNo/pumpName') }}";
