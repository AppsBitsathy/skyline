...
@section('content')
            ...
            <div id="entry" class="col m12">
                <div class="card">
                    ...
                    <div class="card-body pt-5 pb-2">
                        <form method="POST" action="{{ route('8034_entryFullDetailsEntry') }}">
                            @csrf
                            <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col m6 center-align">
                                <form action="{{ route('8034_entryFullDetailsDelete') }}" method="post">
                                    @csrf
    ...
    <div id="reportDateModal" class="modal">
        <form method="post" action="{{ route('8034_entryFullDetailsReport') }}" id="frmReportDate" target="blank">
            @csrf
            <div class="modal-content">
...
@section('custom-script')
    <script type="text/javascript">
        ...
        $('#listpumpnowise').change(function(e) {
            ...
            window.location.href = "{{ URL::to('8034/entry/full_details') }}" + "/pumpnowise/" + selectedPno;
        });

        $('#listTypeWise').change(function(e) {
            let selectedPump = e.target.value;
            window.location.href = "{{ URL::to('8034/entry/full_details') }}" + "/pumptypewise/" + selectedPump;
        });

        $('#pumplistall').change(function(e) {
            window.location.href = "{{ URL::to('8034/entry/full_details') }}";
        });
