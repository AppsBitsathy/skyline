...
@section('content')
    ...
    <div class="container">
                ...
                <div class="card">
                    <div class="card-body pt-4 pb-2">
                        <div class="row mb-4">
                            ...
                            <div class="col m2 center-align">
                                <form action="{{ route('8034_entryPumpTestRDVolDelete') }}" method="post">
                                    @csrf
                        ...
                        <form method="POST" action="{{ route('8034_entryPumpTestRDVolAdd') }}">
                            @csrf
                            <div class="row">
        ...
        <div id="openModal" class="modal">
            {{-- {{  }} --}}
            <form method="GET" action="{{ route('8034_entryPumpTestRDVol') }}" id="frmOpen">
        ...
        <div id="coOrdinatesModal" class="modal">
            {{-- {{ route('8034entryPumpTestRDVolGraphG1') }} --}}
            <form method="GET" action="{{ route('8034_entryPumpTestRDVolGraphG1') }}" id="frmCoord">
                <div class="modal-content">
    ...
    <script>
        $(document).ready(function() {
            ...
            @isset($entries)
                ...
                var url = "{{ URL::to('8034/entry/pump_testing_rd/volumetric/report/pumpNo/pumpName') }}";
