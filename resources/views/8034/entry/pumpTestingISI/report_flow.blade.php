...
<body class="grey lighten-2">
    ...
    <div class="center-align">
        <div class="pb-1">
            ...
            <a class="btn waves-effect btn-flat" href="{{ route('8034_entryPumpTestISIFlowReportDownload') }}">Click
                here to download</a>
        </div>
            ...
            <div class="row left-align">
                <table class="centered white">
                    <tr>
                        ...
                        <td class="no-border"><span id="dateht">{{ explode(' ', $pumpData->fldht)[0] }}</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="no-border-right"><span>Flowmetric Method</span></td>
                        ...
                        <td colspan="2" class="no-border-right"><span>Slip Speed meter</span></td>
                    </tr>
                    <tr>
