...
@section('content')
            ...
            <div class="card p-3">
                <div class="card-body">
                    <div class="row m-2">
                        ...
                        <div class="col m6">
                            <form method="post" action="{{ route('8034_reportPumpMaxMinGetObservedValuesReport') }}"
                                target="blank">
                                @csrf
    ...
    <div id="reportPumpMaxMinModal" class="modal">
        <form method="post" action="{{ route('8034_reportPumpMaxMinGetObservedValues') }}" id="frmReportDate">
            @csrf
