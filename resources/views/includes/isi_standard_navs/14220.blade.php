    ...
    <ul class="collapsible collapsible-accordion">
        <li id="menu1">
            ...
            <div class="collapsible-body">
                <ul>
                    <li id="submenu11">
                        <a class="waves-effect" href="{{ route('14220_masterPumpDeclaredValues') }}"><i
        ...
        <li id="menu2">
            ...
            <div class="collapsible-body">
                <ul>
                                    ...
                                    <ul>
                                        <li id="semisubmenu221">
                                            <a class="waves-effect pl-5"
                                                href="{{ route('14220_entryPumpTestRDVol') }}"><i
                                                    class="material-icons left">subdirectory_arrow_right</i>Volumetric</a>
                                        </li>
                                        <li id="semisubmenu222">
                                            <a class="waves-effect pl-5"
                                                href="{{ route('14220_entryPumpTestRDFlow') }}"><i
                                                    class="material-icons left">subdirectory_arrow_right</i>Flowmetric</a>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <li id="submenu24">
                        <a class="waves-effect" href="{{ route('14220_entryRoutineTesting') }}"><i
                                class="material-icons left">looks_4</i>Routine
                            Testing</a>
                    </li>
                    <li id="submenu25">
                        <a class="waves-effect" href="{{ route('14220_entryFullDetails') }}"><i
...
<li>
    <ul class="collapsible collapsible-accordion">
        <li id="menu3">
            ...
            <div class="collapsible-body">
                <ul>
                    <li id="submenu31"><a class="waves-effect" href="{{ route('14220_reportPumpMaxMin') }}"><i
                                class="material-icons left">import_export</i>Pump Max. Min.
                            Values Report</a>
                    </li>
                    <li id="submenu32"><a class="waves-effect" href="{{ route('14220_reportPumpObserved') }}"><i
                                                                ...
                                                                <ul>
                                                                    <li id="supersemisubmenu4211">
                                                                        <a class="waves-effect pl-5 ml-3"
                                                                            href="{{ route('14220_pumpCompareIndividualCurveTypewiseTH') }}"><i
                                                                                class="material-icons">fiber_manual_record</i>TotalHead</a>
                                                                    </li>
                                                                    <li id="supersemisubmenu4212">
                                                                        <a class="waves-effect pl-5 ml-3"
                                                                            href="{{ route('14220_pumpCompareIndividualCurveTypewiseOAE') }}"><i
                                                                                class="material-icons">fiber_manual_record</i>Overall
                                                                            Efficiency</a>
                                                                    </li>
                                                                    <li id="supersemisubmenu4213">
                                                                        <a class="waves-effect pl-5 ml-3"
                                                                            href="{{ route('14220_pumpCompareIndividualCurveTypewiseI') }}"><i
                                                            ...
                                                            <div class="collapsible-body">
                                                                <ul>
                                                                    <li id="supersemisubmenu4221">
                                                                        <a class="waves-effect pl-5 ml-3"
                                                                            href="{{ route('14220_pumpCompareIndividualCurveAllTypeTH') }}"><i
                                                                                class="material-icons">fiber_manual_record</i>TotalHead</a>
                                                                    </li>
                                                                    <li id="supersemisubmenu4222">
                                                                        <a class="waves-effect pl-5 ml-3"
                                                                            href="{{ route('14220_pumpCompareIndividualCurveAllTypeOAE') }}"><i
                                                                                class="material-icons">fiber_manual_record</i>Overall
                                                                            Efficiency</a>
                                                                    </li>
                                                                    <li id="supersemisubmenu4223">
                                                                        <a class="waves-effect pl-5 ml-3"
                                                                            href="{{ route('14220_pumpCompareIndividualCurveAllTypeI') }}"><i
                                                                                class="material-icons">fiber_manual_record</i>Current</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
...
<li>
    <ul class="collapsible collapsible-accordion">
        <li id="menu6">
            ...
            <div class="collapsible-body">
                <ul>
                    <li id="submenu61"><a class="waves-effect" href="{{ route('14220_helpHelpTopics') }}"><i
                                class="material-icons left">quiz</i>Help Topics</a></li>
                    <li id="submenu62"><a class="waves-effect" href="{{ route('14220_helpErrHelpTopics') }}"><i
                                class="material-icons left">live_help</i>Error Help Topics</a></li>
                    <li id="submenu63">
                        <a class="waves-effect" href="{{ route('14220_helpswp') }}"><i
                                class="material-icons left">account_tree</i>Software Working Procedure</a>
                    </li>
                    <!-- software working procedure export -->
                    <div class="divider"></div>
                    <li id="submenu64"><a class="waves-effect" href="{{ route('14220_aboutSoftware') }}"><i
