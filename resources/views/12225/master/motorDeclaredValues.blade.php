...
@section('content')
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('12225_masterMotorDeclaredValuesStore') }}">
            @csrf
            <div id="entry" class="col s12">
                <div class="card p-5 m-3">
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            <input placeholder="H.P" name="hp" type="text" class="validate" required>
        ...
        <div id="list" class="col s12">
            <div class="card m-3 p-3">
                <div class="row">
                    <form action="{{ route('12225_masterMotorDeclaredValues') }}" method="GET">
                        @csrf
                        <div class="col s12">
                ...
                <table class="responsive-table white">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th>H.P</th>
                            <th>Power</th>
                            <th>Rated Full Load Speed</th>
                            <th>Length of the Arm</th>
                        </tr>
                    </thead>
    ...
    <div id="editModal" class="modal modal-fixed-footer">
        <div class="modal-content">
            <h4>EDIT</h4>
            <form method="POST" action="{{ route('12225_masterMotorDeclaredValuesUpdate') }}">
                @csrf
                <div class="row">
                    ...
                    <div class="input-field col s6">
                        <input placeholder="H.P" name="hp" id="hp" type="text" class="validate" required>
                        <label for="hp">H.P</label>
                    </div>
                    <div class="input-field col s6">
...
@section('custom-script')
    <script>
        ...
        $('#listMotorTypes').change(function(e) {
            ...
            window.location.href = "{{ URL::to('12225/master/motor_declared_values') }}" + "/" + selectedMotor;
        });

        $('#motorListAll').change(function(e) {
            $('#progress').removeClass('hide');
            window.location.href = "{{ URL::to('12225/master/motor_declared_values') }}";
        })
