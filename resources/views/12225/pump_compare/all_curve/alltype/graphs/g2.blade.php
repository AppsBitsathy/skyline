...
//        data.push(trace6);
        ...
        function callG1() {
            ...
            window.location.href = "{{ URL::to('12225/pump_comparison/all_curve/alltype/graphs/g1') }}" + "?" +
                parameters[1];
        }

        function callG2() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/pump_comparison/all_curve/alltype/graphs/g2') }}" + "?" +
                parameters[1];
        }

        function callG3() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/pump_comparison/all_curve/alltype/graphs/g3') }}" + "?" +
                parameters[1];
        }

        function callG4() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/pump_comparison/all_curve/alltype/graphs/g4') }}" + "?" +
                parameters[1];
        }

        function callG5() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/pump_comparison/all_curve/alltype/graphs/g5') }}" + "?" +
                parameters[1];
        }

        function callG6() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/pump_comparison/all_curve/alltype/graphs/g6') }}" + "?" +
                parameters[1];
        }
