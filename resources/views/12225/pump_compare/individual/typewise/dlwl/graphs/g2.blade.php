...
@section('custom-script')
    <script>
            ...
            for (let i = 0; i < trace3x.length; i++) {
                for (let j = trace3x[i]; j <= trace3x[i + 1]; j = j + 0.050) {
                    if (j > 0) {
                        ...
                        l1 = ((j - trace3x[i + 1]) * (j - altXPlus2)) / ((trace3x[i] - trace3x[i + 1]) * (trace3x[i] - altXPlus2));
                        ...
                        l3 = ((j - trace3x[i]) * (j - trace3x[i + 1])) / ((altXPlus2 - trace3x[i]) * (altXPlus2 - trace3x[i + 1]));
            ...
            for (let i = 0; i < trace4x.length; i++) {
                for (let j = trace4x[i]; j <= trace4x[i + 1]; j = j + 0.050) {
                    if (j > 0) {
                        ...
                        l1 = ((j - trace4x[i + 1]) * (j - altXPlus2)) / ((trace4x[i] - trace4x[i + 1]) * (trace4x[i] - altXPlus2));
                        l2 = ((j - trace4x[i]) * (j - altXPlus2)) / ((trace4x[i + 1] - altXPlus2) * (trace4x[i + 1] - trace4x[i]));
                        l3 = ((j - trace4x[i]) * (j - trace4x[i + 1])) / ((altXPlus2 - trace4x[i]) * (altXPlus2 - trace4x[i + 1]));
        ...
        function callG1() {
            ...
            window.location.href = "{{ URL::to('12225/pump_comparison/individual_curve/typewise/dlwl/graphs/g1') }}" + "?" +
                parameters[1];
        }

        function callG2() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/pump_comparison/individual_curve/typewise/dlwl/graphs/g2') }}" + "?" +
                parameters[1];
        }

        function callG3() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/pump_comparison/individual_curve/typewise/dlwl/graphs/g3') }}" + "?" +
                parameters[1];
        }

        function callG4() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/pump_comparison/individual_curve/typewise/dlwl/graphs/g4') }}" + "?" +
                parameters[1];
        }

        function callG5() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/pump_comparison/individual_curve/typewise/dlwl/graphs/g5') }}" + "?" +
                parameters[1];
        }

        function callG6() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/pump_comparison/individual_curve/typewise/dlwl/graphs/g6') }}" + "?" +
                parameters[1];
        }
