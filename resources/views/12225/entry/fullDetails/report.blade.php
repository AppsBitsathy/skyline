...
<body class="grey lighten-2">
    ...
    <div class="center-align">
        <div class="pb-1">
            ...
            <h6>Full Details Report For Centrifugal Jet Pump As Per IS - 12225</h6>
            <form action="{{ route('12225_entryFullDetailsReportDownload') }}" method="post">
                @csrf
        ...
        <div class="row left-align">
            ...
            <table class="centered white">
                <tr>
                    ...
                    <td colspan="2" class="no-border"><span id="">{{ $pump->fldptype }}</span></td>
                </tr>
                <tr>
                    ...
                    <td rowspan="2"><b>DLWL (m)</b></td>
                    <td rowspan="2"><b>Input Power (kW)</b></td>
