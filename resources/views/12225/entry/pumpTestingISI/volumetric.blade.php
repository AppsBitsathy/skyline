...
@section('content')
    ...
    <div class="container">
                ...
                <div class="card">
                    <div class="card-body pt-4 pb-2">
                        <div class="row mb-4">
                            ...
                            <div class="col m2 center-align">
                                {{-- {{ route('entryPumpTestISIVolDelete') }} --}}
                                <form action="{{ route('12225_entryPumpTestISIVolDelete') }}" method="post">
                                    @csrf
                        ...
                        <form method="POST" action="{{ route('12225_entryPumpTestISIVolAdd') }}">
                            @csrf
                            <div class="row">
        ...
        <div id="openModal" class="modal">
            {{-- {{  }} --}}
            <form method="GET" action="{{ route('12225_entryPumpTestISIVol') }}" id="frmOpen">
        ...
        <div id="coOrdinatesModal" class="modal">
            ...
            <form method="GET" action="{{ route('12225_entryPumpTestISIVolGraphG1') }}" id="frmCoord">
                <div class="modal-content">
    ...
    <script>
        $(document).ready(function() {
            ...
            @isset($entries)
                ...
                var url = "{{ URL::to('12225/entry/pump_testing_isi/volumetric/report/pumpNo/pumpName') }}";
