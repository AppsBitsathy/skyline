...
@section('custom-script')
    <script>
        ...
        for (let k = 0; k <= rec - 2; k++) {
            ...
            for (let j = trace1x[k]; j <= trace1x[k + 1]; j = j + 0.003) {
                w = j - trace1x[k];
        ...
        for (let k = 0; k <= rec - 2; k++) {
            ...
            for (let j = trace2x[k]; j <= trace2x[k + 1]; j = j + 0.003) {
                w = j - trace2x[k];
        ...
        for (let k = 0; k <= rec - 2; k++) {
            ...
            sk3 = (tempUse2 - tempUse1) / (6 * h[k]);
            let jj;
            for (let j = i; j <= trace3x[k + 1]; j = j + 0.003) {
                w = j - trace3x[k];
        ...
        for (let k = 0; k <= rec - 2; k++) {
            ...
            sk3 = (tempUse2 - tempUse1) / (6 * h[k]);
            let jj;
            for (let j = i; j <= trace4x[k + 1]; j = j + 0.003) {
                w = j - trace4x[k];
