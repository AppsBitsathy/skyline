...
<title>Entry - Pump Testing R & D - Flowmetric</title>
@php
$rId = 222;
$srId = 22;
$rMain = 2;
...
@section('content')
    ...
    <div class="container">
                ...
                <div class="card">
                    <div class="card-body pt-4 pb-2">
                        <div class="row mb-4">
                            ...
                            <div class="col m2 center-align">
                                <form action="{{ route('12225_entryPumpTestRDFlowDelete') }}" method="post">
                                    @csrf
                        ...
                        <form method="POST" action="{{ route('12225_entryPumpTestRDFlowSubmit') }}">
                            @csrf
                            <div class="row">
                                        ...
                                        <tbody id="tableBody">
                                            <tr id="row1">
                                                ...
                                                <td><input type="text" name="pressureGaugeReading[]" id="tblPGauge"
                                                        required></td>
                                                <td><input type="text" name="discharge[]" id="tblDis" required></td>
        ...
        <div id="openModal" class="modal">
            {{-- {{  }} --}}
            <form method="GET" action="{{ route('12225_entryPumpTestRDFlow') }}" id="frmOpen">
        ...
        <div id="coOrdinatesModal" class="modal">
            {{-- {{ route ('12225_entryPumpTestRDFlowGraphG1') }} --}}
            <form method="GET" action="{{ route('12225_entryPumpTestRDFlowGraphG1') }}" id="frmCoord">
                <div class="modal-content">
    ...
    <script>
        $(document).ready(function() {
            ...
            @isset($entries)
                ...
                var url = "{{ URL::to('12225/entry/pump_testing_rd/flowmetric/report/pumpNo/pumpName') }}";
                ...
                @foreach ($entries as $data)
                    ...
                    @if ($data->fldread == 1)
                        ...
                        $('#tblDis').val('{{ round($data->fldadis, 2) }}');
                    ...
                    @else
                        ...
                        html += '<tr id="row' + {{ $data->fldread }} + '">'
                            ...
                            +'<td><input type="text" name="discharge[]" required value="'+{{ round($data->fldadis, 2) }}+'"></td>'
        ...
        $('#addRow').click(function(e) {
            ...
            html += '<td><input type="text" name="discharge[]" required></td >';
