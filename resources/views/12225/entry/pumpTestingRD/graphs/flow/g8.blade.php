...
@section('custom-script')
    ...
    <script>
        ...
        for (let i = 1; i <= xx1.length - 1; i++) {
            if ((xx1[i] - xx1[i - 1]) > {{ $isiGraphScaleValues['xaxis'] }}) {
                trace1x[tempj] = xx1[i];
                trace1y[tempj] = yy1[i];
                trace2x[tempj] = xx2[i];
                trace2y[tempj] = yy2[i];
        ...
        function defaultGraph(visibleX1, visibleX2, visibleX3, selectedXAxis) {
            ...
            let sv = {{ $flowmetricsValuesASC[0]['fldrdis'] / 10.9 }};
            ...
            sv = {{ $flowmetricsValuesASC[0]['fldrdis'] / 10.9 }};
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/flow/g8/excel') }}" + "?" +
                parameters[1];
        }
