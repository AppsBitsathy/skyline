        ...
        <div class="col s12 m2 l2 card">
            <div class="row center">
                ...
                <div class="col m12 pb-1">
                    <form method="post" action="{{ route('12225_entryPumpTestRDFlowGraphReport') }}" target="blank">
                        @csrf
                ...
                <div class="col m12 pb-1">
                    <form action="{{ route('12225_entryPumpTestRDFlowGraphAddPrint') }}" method="post">
                        @csrf
...
@section('custom-script')
    ...
    <script>
        ...
        @foreach ($flowmetricsValues as $flow)
            xx1[tempj] = {{ $flow['fldrdis'] }};
            yy1[tempj] = {{ $flow['fldrthead'] }};
            xx2[tempj] = {{ $flow['fldrdis'] }};
            yy2[tempj] = {{ $flow['fldrdlwl'] }};
            xx3[tempj] = {{ $flow['fldrdis'] }};
            yy3[tempj] = {{ $flow['fldipow'] }};
            xx4[tempj] = {{ $flow['fldrdis'] }};
            yy4[tempj] = {{ $flow['fldcurr'] }};
            tempj = tempj + 1;
        @endforeach


        // for (let i = 1; i <= xx1.length - 2; i++) {
        //     tempxx1[i] = (xx1[i + 1] + xx1[i - 1]) / 2;
        //     tempyy1[i] = (yy1[i + 1] + yy1[i - 1]) / 2;
        //     tempxx2[i] = (xx2[i + 1] + xx2[i - 1]) / 2;
        //     tempyy2[i] = (yy2[i + 1] + yy2[i - 1]) / 2;
        //     tempxx3[i] = (xx3[i + 1] + xx3[i - 1]) / 2;
        //     tempyy3[i] = (yy3[i + 1] + yy3[i - 1]) / 2;
        //     tempxx4[i] = (xx4[i + 1] + xx4[i - 1]) / 2;
        //     tempyy4[i] = (yy4[i + 1] + yy4[i - 1]) / 2;
        // }
        ...
        // for (let i = 1; i <= xx1.length - 1; i++) {
        //     trace1x[i] = (xx1[i] + tempxx1[i]) / 2;
        //     trace1y[i] = (yy1[i] + tempyy1[i]) / 2;
        //     trace2x[i] = (xx2[i] + tempxx2[i]) / 2;
        //     trace2y[i] = (yy2[i] + tempyy2[i]) / 2;
        //     trace3x[i] = (xx3[i] + tempxx3[i]) / 2;
        //     trace3y[i] = (yy3[i] + tempyy3[i]) / 2;
        //     trace4x[i] = (xx4[i] + tempxx4[i]) / 2;
        //     trace4y[i] = (yy4[i] + tempyy4[i]) / 2;
        // }

        // trace1x[xx1.length - 1] = xx1[xx1.length - 1];
        // trace1y[xx1.length - 1] = yy1[xx1.length - 1];
        // trace2x[xx2.length - 1] = xx2[xx2.length - 1];
        // trace2y[xx2.length - 1] = yy2[xx2.length - 1];
        // trace3x[xx3.length - 1] = xx3[xx3.length - 1];
        // trace3y[xx3.length - 1] = yy3[xx3.length - 1];
        // trace4x[xx4.length - 1] = xx4[xx4.length - 1];
        // trace4y[xx4.length - 1] = yy4[xx4.length - 1];
        ...
        function defaultGraph(visibleX1, visibleX2, visibleX3, selectedXAxis) {
            ...
            for (let i = 1; i <= xx1.length - 2; i++) {
                tempxx1[i] = (altx1[i + 1] + altx1[i - 1]) / 2;
                tempyy1[i] = (alty1[i + 1] + alty1[i - 1]) / 2;
                tempxx2[i] = (altx2[i + 1] + altx2[i - 1]) / 2;
                tempyy2[i] = (alty2[i + 1] + alty2[i - 1]) / 2;
                tempxx3[i] = (altx3[i + 1] + altx3[i - 1]) / 2;
                tempyy3[i] = (alty3[i + 1] + alty3[i - 1]) / 2;
                tempxx4[i] = (altx4[i + 1] + altx4[i - 1]) / 2;
                tempyy4[i] = (alty4[i + 1] + alty4[i - 1]) / 2;
            }
            ...
            for (let i = 1; i <= xx1.length - 1; i++) {
                trace1x[i] = (altx1[i] + (tempxx1[i] == undefined ? 0 : tempxx1[i])) / 2;
                trace1y[i] = (alty1[i] + (tempyy1[i] == undefined ? 0 : tempyy1[i])) / 2;
                trace2x[i] = (altx2[i] + (tempxx2[i] == undefined ? 0 : tempxx2[i])) / 2;
                trace2y[i] = (alty2[i] + (tempyy2[i] == undefined ? 0 : tempyy2[i])) / 2;
                trace3x[i] = (altx3[i] + (tempxx3[i] == undefined ? 0 : tempxx3[i])) / 2;
                trace3y[i] = (alty3[i] + (tempyy3[i] == undefined ? 0 : tempyy3[i])) / 2;
                trace4x[i] = (altx4[i] + (tempxx4[i] == undefined ? 0 : tempxx4[i])) / 2;
                trace4y[i] = (alty4[i] + (tempyy4[i] == undefined ? 0 : tempyy4[i])) / 2;
            }
            ...
            let sv = {{ $flowmetricsValuesASC[0]['fldrdis'] / 16.99999 }};

            k = 1;
            jj = 0;

            for (let i = 0; i <= rec - 1; i++) {
                for (let j = jj; j <= temp1x[i + 1]; j = j + sv) {
                    if (j > 0) {
                        let y1 = temp1y[i] + (j - temp1x[i]) * (((temp1y[i + 1]) - temp1y[(i)]) / (temp1x[i + 1] -
                            temp1x[
                                i]));
                        xy[k] = [];
            ...
            sv = {{ $flowmetricsValuesASC[0]['fldrdis'] / 16.99999 }};

            k = 1;
            jj = 0;

            for (let i = 0; i <= rec - 1; i++) {
                for (let j = jj; j <= temp2x[i + 1]; j = j + sv) {
                    if (j > 0) {
                        let y1 = temp2y[i] + (j - temp2x[i]) * (((temp2y[i + 1]) - temp2y[(i)]) / (temp2x[i + 1] -
                            temp2x[i]));
                        xy[k] = [];
                        xy[k][0] = parseFloat(parseFloat(j).toFixed(2));
                        xy[k][1] = y1;
            ...
            for (let i = 0; i <= rec - 1; i++) {
                for (let j = jj; j <= temp3x[i + 1]; j = j + sv) {
                    if (j > 0) {
                        let y1 = temp3y[i] + (j - temp3x[i]) * (((temp3y[i + 1]) - temp3y[(i)]) / (temp3x[i + 1] -
                            temp3x[i]));
                        xy[k] = [];
                        xy[k][0] = parseFloat(parseFloat(j).toFixed(2));
                        xy[k][1] = y1;
            ...
            for (let i = 0; i <= rec - 1; i++) {
                for (let j = jj; j <= temp4x[i + 1]; j = j + sv) {
                    if (j > 0) {
                        let y1 = temp4y[i] + (j - temp4x[i]) * (((temp4y[i + 1]) - temp4y[(i)]) / (temp4x[i + 1] -
                            temp4x[i]));
                        xy[k] = [];
                        xy[k][0] = parseFloat(parseFloat(j).toFixed(2));
                        xy[k][1] = y1;
            ...
            @for ($i = 0; $i < count($flowmetricsValues); $i++)
                trace1x[{{ $i }}] = {{ $flowmetricsValues[$i]['fldrdis'] }};
                trace1y[{{ $i }}] = yy1[{{ $i }}];
                trace2x[{{ $i }}] = {{ $flowmetricsValues[$i]['fldrdis'] }};
                trace2y[{{ $i }}] = yy2[{{ $i }}];
                trace3x[{{ $i }}] = {{ $flowmetricsValues[$i]['fldrdis'] }};
                trace3y[{{ $i }}] = yy3[{{ $i }}];
                trace4x[{{ $i }}] = {{ $flowmetricsValues[$i]['fldrdis'] }};
                trace4y[{{ $i }}] = yy4[{{ $i }}];
            @endfor
            // }
            // else {
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/flow/g9/excel') }}" + "?" +
                parameters[1];
        }
        ...
        function callG1() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/flow/g1') }}" + "?" + parameters[1];
        }
        ...
        function callG2() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/flow/g2') }}" + "?" + parameters[1];
        }
        ...
        function callG3() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/flow/g3') }}" + "?" + parameters[1];
        }
        ...
        function callG4() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/flow/g4') }}" + "?" + parameters[1];
        }
        ...
        function callG5() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/flow/g5') }}" + "?" + parameters[1];
        }
        ...
        function callG6() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/flow/g6') }}" + "?" + parameters[1];
        }
        ...
        function callG7() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/flow/g7') }}" + "?" + parameters[1];
        }
        ...
        function callG8() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/flow/g8') }}" + "?" + parameters[1];
        }
        ...
        function callG9() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/flow/g9') }}" + "?" + parameters[1];
        }
        ...
        function callG10() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/flow/g10') }}" + "?" + parameters[1];
        }
