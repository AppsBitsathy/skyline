...
@section('custom-script')
    ...
    <script>
        ...
        trace1x[tempj] = {{ $flowmetricsValues[$tempj]['fldrdis'] }};
        trace1y[tempj] = {{ $flowmetricsValues[$tempj]['fldrthead'] }};
        trace2x[tempj] = {{ $flowmetricsValues[$tempj]['fldrdis'] }};
        trace2y[tempj] = {{ $flowmetricsValues[$tempj]['fldrdlwl'] }};
        trace3x[tempj] = {{ $flowmetricsValues[$tempj]['fldrdis'] }};
        trace3y[tempj] = {{ $flowmetricsValues[$tempj]['fldipow'] }};
        trace4x[tempj] = {{ $flowmetricsValues[$tempj]['fldrdis'] }};
        trace4y[tempj] = {{ $flowmetricsValues[$tempj]['fldcurr'] }};
        ...
        trace1x[tempj] = {{ $flowmetricsValuesASC[0]['fldrdis'] }};
        trace1y[tempj] = {{ $flowmetricsValuesASC[0]['fldrthead'] }};
        trace2x[tempj] = {{ $flowmetricsValuesASC[0]['fldrdis'] }};
        trace2y[tempj] = {{ $flowmetricsValuesASC[0]['fldrdlwl'] }};
        trace3x[tempj] = {{ $flowmetricsValuesASC[0]['fldrdis'] }};
        trace3y[tempj] = {{ $flowmetricsValuesASC[0]['fldipow'] }};
        trace4x[tempj] = {{ $flowmetricsValuesASC[0]['fldrdis'] }};
        trace4y[tempj] = {{ $flowmetricsValuesASC[0]['fldcurr'] }};

        tempj = tempj - 1;

        trace1x[tempj] = {{ $flowmetricsValuesASC[2]['fldrdis'] }};
        trace1y[tempj] = {{ $flowmetricsValuesASC[2]['fldrthead'] }};
        trace2x[tempj] = {{ $flowmetricsValuesASC[2]['fldrdis'] }};
        trace2y[tempj] = {{ $flowmetricsValuesASC[2]['fldrdlwl'] }};
        trace3x[tempj] = {{ $flowmetricsValuesASC[2]['fldrdis'] }};
        trace3y[tempj] = {{ $flowmetricsValuesASC[2]['fldipow'] }};
        trace4x[tempj] = {{ $flowmetricsValuesASC[2]['fldrdis'] }};
        trace4y[tempj] = {{ $flowmetricsValuesASC[2]['fldcurr'] }};
        ...
        function defaultGraph(visibleX1, visibleX2, visibleX3, selectedXAxis) {
            ...
            let sv = {{ $flowmetricsValuesASC[0]['fldrdis'] / 15.5 }};
            ...
            sv = {{ $flowmetricsValuesASC[0]['fldrdis'] / 15.5 }};
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/flow/g7/excel') }}" + "?" +
                parameters[1];
        }
