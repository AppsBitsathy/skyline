...
@section('custom-script')
    ...
    <script>
        ...
        // for (let i = 0; i <= xx1.length - 3; i++) {
        //     trace1x[i + 1] = (xx1[i] + xx1[i + 1] + xx1[i + 2]) / 3;
        //     trace1y[i + 1] = (yy1[i] + yy1[i + 1] + yy1[i + 2]) / 3;
        //     trace2x[i + 1] = (xx2[i] + xx2[i + 1] + xx2[i + 2]) / 3;
        //     trace2y[i + 1] = (yy2[i] + yy2[i + 1] + yy2[i + 2]) / 3;
        //     trace3x[i + 1] = (xx3[i] + xx3[i + 1] + xx3[i + 2]) / 3;
        //     trace3y[i + 1] = (yy3[i] + yy3[i + 1] + yy3[i + 2]) / 3;
        //     trace4x[i + 1] = (xx4[i] + xx4[i + 1] + xx4[i + 2]) / 3;
        //     trace4y[i + 1] = (yy4[i] + yy4[i + 1] + yy4[i + 2]) / 3;
        //     ii = i + 1;
        // }

        // trace1x[ii] = xx1[xx1.length - 1];
        // trace1y[ii] = yy1[yy1.length - 1];
        // trace2x[ii] = xx2[xx2.length - 1];
        // trace2y[ii] = yy2[yy2.length - 1];
        // trace3x[ii] = xx3[xx3.length - 1];
        // trace3y[ii] = yy3[yy3.length - 1];
        // trace4x[ii] = xx4[xx4.length - 1];
        // trace4y[ii] = yy4[yy4.length - 1];
        ...
        function defaultGraph(visibleX1, visibleX2, visibleX3, selectedXAxis) {
            ...
            for (let i = 0; i <= xx1.length - 3; i++) {
                trace1x[i + 1] = (altx1[i] + (altx1[i + 1] == undefined ? 0 : altx1[i + 1]) + (altx1[i + 2] == undefined ?
                    0 : altx1[i + 2])) / 3;
                trace1y[i + 1] = (alty1[i] + (alty1[i + 1] == undefined ? 0 : alty1[i + 1]) + (alty1[i + 2] == undefined ?
                    0 : alty1[i + 2])) / 3;
                trace2x[i + 1] = (altx2[i] + (altx2[i + 1] == undefined ? 0 : altx2[i + 1]) + (altx2[i + 2] == undefined ?
                    0 : altx2[i + 2])) / 3;
                trace2y[i + 1] = (alty2[i] + (alty2[i + 1] == undefined ? 0 : alty2[i + 1]) + (alty2[i + 2] == undefined ?
                    0 : alty2[i + 2])) / 3;
                trace3x[i + 1] = (altx3[i] + (altx3[i + 1] == undefined ? 0 : altx3[i + 1]) + (altx3[i + 2] == undefined ?
                    0 : altx3[i + 2])) / 3;
                trace3y[i + 1] = (alty3[i] + (alty3[i + 1] == undefined ? 0 : alty3[i + 1]) + (alty3[i + 2] == undefined ?
                    0 : alty3[i + 2])) / 3;
                trace4x[i + 1] = (altx4[i] + (altx4[i + 1] == undefined ? 0 : altx4[i + 1]) + (altx4[i + 2] == undefined ?
                    0 : altx4[i + 2])) / 3;
                trace4y[i + 1] = (alty4[i] + (alty4[i + 1] == undefined ? 0 : alty4[i + 1]) + (alty4[i + 2] == undefined ?
                    0 : alty4[i + 2])) / 3;
                ii = i + 1;
            }
            ...
            let sv = {{ $flowmetricsValuesASC[0]['fldrdis'] / 15.9 }};
            ...
            sv = {{ $flowmetricsValuesASC[0]['fldrdis'] / 15.9 }};
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/flow/g10/excel') }}" + "?" +
                parameters[1];
        }
