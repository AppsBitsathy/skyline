            ...
            <div class="row">
                ...
                <div class="col s12 m6 l6">
                    ...
                    <div class="col s12 m12 l12">
                        ...
                        <div class="col s12 m6 l6">
                            <a onclick="changeLineColor(1,'dlwlLineColor')" class="btn waves-effect"><i
                                    class="material-icons">done</i></a>
                        </div>
                    </div>
                    <div class="col s12 m12 l12">
                    ...
                    <div class="col s12 m12 l12">
                        ...
                        <div class="col s12 m6 l6">
                            <a onclick="changeLineColor(3,'currLineColor')" class="btn waves-effect"><i
                                    class="material-icons">done</i></a>
                        </div>
                    </div>
                </div>
...
@section('custom-script')
    ...
    <script>
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/flow/g1/excel') }}" + "?" +
                parameters[1];
        }
        ...
        function callG10() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/flow/g10') }}" + "?" + parameters[
                1] + "&" + unit + "&" + unitFD;
        }
