...
@section('custom-script')
    ...
    <script>
        ...
        function defaultGraph(visibleX1, visibleX2, visibleX3, selectedXAxis) {
            ...
            let sv = {{ $volumetricsValuesASC[0]['fldrdis'] / 10.9 }};
            ...
            sv = {{ $volumetricsValuesASC[0]['fldrdis'] / 10.9 }};
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('12225/entry/pump_testing_rd/graphs/vol/g8/excel') }}" + "?" +
                parameters[1];
        }
