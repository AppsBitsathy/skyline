    ...
    <div class="center-align">
        <div class="pb-1">
            ...
            @isset($startDate)
                ...
                @endisset
            @endisset
            <form action="{{ route('12225_reportPumpObservedFetchDownload') }}" method="post">
                @csrf
            ...
            <table class="centered white">
                @isset($pump)
                    <tr>
                        ...
                        <td><b>Pressure Size</b></td>
                        <td><span>{{ $pump->fldpsize }}</span>&nbsp;mm</td>
                        <td><b>Voltage</b></td>
                        <td><span>{{ $pump->fldvolt }}</span>&nbsp;Volts</td>
                        <td><b>Discharge Size</b></td>
                        <td><span>{{ $pump->flddisize }}</span>&nbsp;mm</td>
                    ...
                    <tr>
                        ...
                        <td><b>DLWL</b></td>
                        <td><span>{{ $pump->flddlwl }}</span>&nbsp;m</td>
                        <td><b>DLWL Range</b></td>
                        <td><span>{{ $pump->flddlwl1 }} to {{ $pump->flddlwl2 }}</span>&nbsp;m</td>
                    </tr>
                @endisset
                <tr>
