...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <!-- entry -->
            {{-- <a href="{{ route('entryPumpTestRDVolReport') }}" class="btn waves-effect">Export as PDF</a> --}}
            <div class="col m12">
                <div class="card">
                    <div class="card-body pt-4 pb-2">
                        <div class="row mb-4">
                            ...
                            <div class="col m2 center-align">
                                <form action="{{ route('entryPumpTestRDVolDelete') }}" method="post">
                                    @csrf
                        ...
                        <form method="POST" action="{{ route('entryPumpTestRDVolAdd') }}">
                            @csrf
                            <div class="row">
        ...
        <div id="openModal" class="modal">
            <form method="GET" action="{{ route('entryPumpTestRDVol') }}" id="frmOpen">
        ...
        <div id="coOrdinatesModal" class="modal">
            <form method="GET" action="{{ route('entryPumpTestRDVolGraphG1') }}" id="frmCoord">
                <div class="modal-content">
    ...
    <script>
        $(document).ready(function() {
            ...
            @if ($entries)
                ...
                var url = "{{ URL::to('9079/entry/pump_testing_rd/volumetric/report/pumpNo/pumpName') }}";
