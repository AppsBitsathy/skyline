...
@section('custom-script')
    ...
    <script>
        ...
        function defaultGraph(visibleX1 = true, visibleX2 = false, visibleX3 = false, selectedXAxis = 'x1') {
            ...
            if (!pointPicked) {
                temp1x[0] = {{ $flowmetricsValues[0]['fldRDis'] }};
                temp1y[0] = {{ $flowmetricsValues[0]['fldRTHead'] }};

                temp1x[1] = dis;
                temp1y[1] = thead;

                temp1x[2] = {{ $flowmetricsValuesASC[0]['fldRDis'] }};
                temp1y[2] = {{ $flowmetricsValuesASC[0]['fldRTHead'] }};
            }
            ...
            temp2x[0] = {{ $flowmetricsValues[0]['fldRDis'] }};
            temp2y[0] = {{ $flowmetricsValues[0]['fldOeff'] }};

            temp2x[1] = dis;
            temp2y[1] = oeff;

            temp2x[2] = {{ $flowmetricsValuesASC[0]['fldRDis'] }};
            temp2y[2] = {{ $flowmetricsValuesASC[0]['fldOeff'] }};
            ...
            temp3x[0] = {{ $flowmetricsValues[0]['fldRDis'] }};
            temp3y[0] = {{ $flowmetricsValues[0]['fldCurr'] }};

            temp3x[1] = dis;
            temp3y[1] = curr;

            temp3x[2] = {{ $flowmetricsValuesASC[0]['fldRDis'] }};
            temp3y[2] = {{ $flowmetricsValuesASC[0]['fldCurr'] }};
