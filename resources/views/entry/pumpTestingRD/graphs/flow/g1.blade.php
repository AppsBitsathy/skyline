...
@section('custom-script')
    ...
    <script>
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/flow/g1/excel') }}" + "?" + parameters[1];
        }
        ...
        function callG1() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/flow/g1') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG2() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/flow/g2') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG3() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/flow/g3') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG4() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/flow/g4') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG5() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/flow/g5') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG6() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/flow/g6') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG7() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/flow/g7') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG8() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/flow/g8') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG9() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/flow/g9') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG10() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/flow/g10') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
            ...
            if (e.target.checked) {
                ...
                myPlot.on('plotly_hover', function(data) {
                        var infotext = data.points.map(function(d) {
                            // return (d.data.name + ': Q= ' + d.x + ', y= ' + d.y.toPrecision(3) + '<br>' + (d.y * 7.4));
