...
@section('custom-script')
    ...
    <script>
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g1/excel') }}" + "?" + parameters[1];
        }
        ...
        function callG1() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g1') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG2() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g2') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG3() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g3') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG4() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g4') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG5() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g5') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG6() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g6') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG7() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g7') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG8() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g8') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG9() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g9') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
        ...
        function callG10() {
            ...
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g10') }}" + "?" + parameters[1] + "&" + unit + "&" + unitFD;
        }
