        ...
        <div class="col s12 m2 l2 card">
            <div class="row center">
                ...
                <div class="col m12 pb-1">
                    <form method="post" action="{{ route('entryPumpTestRDVolGraphReport') }}" target="blank">
                        @csrf
                ...
                <div class="col m12 pb-1">
                    <form action="{{ route('entryPumpTestRDVolGraphAddPrint') }}" method="post">
                        @csrf
...
@section('custom-script')
    ...
    <script>
        ...
        function downloadToExcel() {
            ...
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g3/excel') }}" + "?" + parameters[1];
        }
        ...
        function callG1() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g1') }}" + "?" + parameters[1];
        }

        function callG2() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g2') }}" + "?" + parameters[1];
        }

        function callG3() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g3') }}" + "?" + parameters[1];
        }

        function callG4() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g4') }}" + "?" + parameters[1];
        }

        function callG5() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g5') }}" + "?" + parameters[1];
        }

        function callG6() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g6') }}" + "?" + parameters[1];
        }

        function callG7() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g7') }}" + "?" + parameters[1];
        }

        function callG8() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g8') }}" + "?" + parameters[1];
        }

        function callG9() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g9') }}" + "?" + parameters[1];
        }

        function callG10() {
            let parameters = window.location.href.split('?');
            window.location.href = "{{ URL::to('9079/entry/pump_testing_rd/graphs/vol/g10') }}" + "?" + parameters[1];
        }
