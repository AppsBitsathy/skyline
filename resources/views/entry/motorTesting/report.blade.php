...
<body class="grey lighten-2">
    ...
    <div class="center-align">
        <div class="pb-1">
            ...
            <h6>Motor Performance Test As Per IS - 9079</h6>
            <a class="btn waves-effect btn-flat" href="{{ route('entryMotorTestingReportDownload') }}">Click here
                to download</a>
        </div>
        ...
        <div class="row left-align">
            ...
            <table class="centered white">
                ...
                <tr>
                    ...
                    <td colspan="3"><b>Temp. Rise Test at 240 V</b></td>
                    <td colspan="3"><b>Temp. Rise Test at 204 V</b></td>
                ...
                <tr>
                    ...
                    <td><b>Temp Rise at 240 V</b></td>
                    <td><b>Temp Rise at 204 V</b></td>
                </tr>
