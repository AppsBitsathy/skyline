...
@section('content')
    ...
    <div class="container">
            ...
            <div class="col m12">
                <div class="card">
                    <div class="card-body pt-4 pb-2">
                        ...
                        <form method="POST" action="{{ route('entryPumpTestISIFlowSubmit') }}" id="entryForm">
                            @csrf
                            <div class="row">
        ...
        <div id="openModal" class="modal">
            <form method="GET" action="{{ route('entryPumpTestISIFlow') }}" id="frmOpen">
        ...
        <div id="coOrdinatesModal" class="modal">
            <form method="GET" action="{{ route('entryPumpTestISIFlowGraphG1') }}" id="frmCoord">
                <div class="modal-content">
...
@section('custom-script')
    <script>
        $(document).ready(function() {
            ...
            @endfor $('#entryForm').attr('action','{{ route('entryPumpTestISIFlowUpdate') }}');
            $('#btnGraph').removeClass('disabled'); $('#btnDelete').removeClass('disabled');
            $('#btnReport').attr("disabled", false); var
            url="{{ URL::to('9079/entry/pump_testing_isi/flowmetric/report/pumpNo/pumpName') }}" ;
        ...
        readTextFile("file:///C:/Users/ADC/Desktop/samplereport 9079.TXT");
    </script>
@endsection
